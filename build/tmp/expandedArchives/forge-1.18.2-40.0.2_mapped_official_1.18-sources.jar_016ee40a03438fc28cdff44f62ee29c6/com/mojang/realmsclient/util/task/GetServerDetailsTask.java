   ...
   public void run() {
      ...
      try {
         ...
         default:
            ...
            f_202337_.error("Couldn't connect to world", (Throwable)realmsserviceexception);
            return;
         }
         ...
         f_202337_.error("Couldn't connect to world", (Throwable)exception);
         ...
         try {
            if (p_167645_) {
               this.scheduleResourcePackDownload(p_167640_).thenRun(() -> {
                  ...
                  f_202337_.error("Failed to download resource pack from {}", p_167640_, p_202341_);
