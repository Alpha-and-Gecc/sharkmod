...
public class ScreenManager {
   ...
   private void onMonitorChange(long p_85274_, int p_85275_) {
      ...
      if (p_85275_ == 262145) {
         ...
         f_212357_.debug("Monitor {} connected. Current monitors: {}", p_85274_, this.monitors);
      } else if (p_85275_ == 262146) {
         this.monitors.remove(p_85274_);
         f_212357_.debug("Monitor {} disconnected. Current monitors: {}", p_85274_, this.monitors);
      }
   ...
   public Monitor findBestMonitor(Window p_85277_) {
      ...
      if (i != 0L) {
         ...
         f_212357_.debug("Selecting monitor - primary: {}, current monitors: {}", k1, this.monitors);
         ...
         for(Monitor monitor1 : this.monitors.values()) {
            ...
            if (j4 > j1) {
               ...
               f_212357_.debug("Primary monitor {} is preferred to monitor {}", monitor1, monitor);
               monitor = monitor1;
            }
         }

         f_212357_.debug("Selected monitor: {}", (Object)monitor);
         return monitor;
      }
   }
