...
public class GameData
{
    ...
    public static void init()
    {
        ...
        // Game objects
        makeRegistry(BLOCKS, Block.class, "air").addCallback(BlockCallbacks.INSTANCE).legacyName("blocks").vanillaHolder(Block::m_204297_).create();
        makeRegistry(FLUIDS, Fluid.class, "empty").vanillaHolder(Fluid::m_205069_).create();
        makeRegistry(ITEMS, Item.class, "air").addCallback(ItemCallbacks.INSTANCE).legacyName("items").vanillaHolder(Item::m_204114_).create();
        ...
        makeRegistry(ENTITY_TYPES, c(EntityType.class), "pig").legacyName("entities").vanillaHolder(EntityType::m_204041_).create();
    ...
    public static void freezeData()
    {
        ...
        Registry.REGISTRY.stream().filter(r -> r instanceof MappedRegistry).forEach(r -> ((MappedRegistry<?>)r).m_203521_());
