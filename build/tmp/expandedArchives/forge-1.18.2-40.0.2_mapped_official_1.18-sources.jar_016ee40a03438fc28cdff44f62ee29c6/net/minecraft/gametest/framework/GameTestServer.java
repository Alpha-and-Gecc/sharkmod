...
public class GameTestServer extends MinecraftServer {
   ...
   public static GameTestServer m_206606_(Thread p_206607_, LevelStorageSource.LevelStorageAccess p_206608_, PackRepository p_206609_, Collection<GameTestBatch> p_206610_, BlockPos p_206611_) {
      if (p_206610_.isEmpty()) {
         ...
         try {
            WorldStem worldstem = WorldStem.m_206911_(worldstem$initconfig, () -> {
               ...
               Registry<StructureSet> registry1 = registryaccess$frozen.registryOrThrow(Registry.f_211073_);
               Registry<DimensionType> registry2 = registryaccess$frozen.registryOrThrow(Registry.DIMENSION_TYPE_REGISTRY);
               WorldData worlddata = new PrimaryLevelData(TEST_SETTINGS, new WorldGenSettings(0L, false, false, WorldGenSettings.m_204649_(registry2, DimensionType.m_204490_(registryaccess$frozen, 0L), new FlatLevelSource(registry1, FlatLevelGeneratorSettings.m_211734_(registry, registry1)))), Lifecycle.stable());
   ...
   public boolean initServer() {
      this.setPlayerList(new PlayerList(this, this.m_206579_(), this.playerDataStorage, 1) {
      });
