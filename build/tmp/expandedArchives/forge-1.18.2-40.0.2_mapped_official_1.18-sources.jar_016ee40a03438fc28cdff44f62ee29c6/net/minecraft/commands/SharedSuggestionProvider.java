...
public interface SharedSuggestionProvider {
   ...
   CompletableFuture<Suggestions> m_212155_(CommandContext<?> p_212334_);
   ...
   default void m_212335_(Registry<?> p_212336_, SharedSuggestionProvider.ElementSuggestionType p_212337_, SuggestionsBuilder p_212338_) {
      if (p_212337_.m_212351_()) {
         m_205106_(p_212336_.m_203613_().map(TagKey::f_203868_), p_212338_, "#");
      }
   ...
   CompletableFuture<Suggestions> m_212095_(ResourceKey<? extends Registry<?>> p_212339_, SharedSuggestionProvider.ElementSuggestionType p_212340_, SuggestionsBuilder p_212341_, CommandContext<?> p_212342_);
   ...
   static CompletableFuture<Suggestions> m_205106_(Stream<ResourceLocation> p_205107_, SuggestionsBuilder p_205108_, String p_205109_) {
