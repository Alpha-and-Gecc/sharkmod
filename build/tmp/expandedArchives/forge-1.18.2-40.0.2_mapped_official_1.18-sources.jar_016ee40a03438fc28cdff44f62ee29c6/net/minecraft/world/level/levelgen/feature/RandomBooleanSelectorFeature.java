...
public class RandomBooleanSelectorFeature extends Feature<RandomBooleanFeatureConfiguration> {
   ...
   public boolean place(FeaturePlaceContext<RandomBooleanFeatureConfiguration> p_160208_) {
      ...
      return ((PlacedFeature)(flag ? randombooleanfeatureconfiguration.featureTrue : randombooleanfeatureconfiguration.featureFalse).m_203334_()).place(worldgenlevel, chunkgenerator, random, blockpos);
   }
}