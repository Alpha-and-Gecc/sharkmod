...
public class SurfaceSystem {
   ...
   public void buildSurface(BiomeManager p_189945_, Registry<Biome> p_189946_, boolean p_189947_, WorldGenerationContext p_189948_, final ChunkAccess p_189949_, NoiseChunk p_189950_, SurfaceRules.RuleSource p_189951_) {
      ...
      SurfaceRules.Context surfacerules$context = new SurfaceRules.Context(this, p_189949_, p_189950_, p_189945_::m_204214_, p_189946_, p_189948_);
      ...
      for(int k = 0; k < 16; ++k) {
         for(int l = 0; l < 16; ++l) {
            ...
            Holder<Biome> holder = p_189945_.m_204214_(blockpos$mutableblockpos1.set(i1, p_189947_ ? 0 : k1, j1));
            if (holder.m_203565_(Biomes.ERODED_BADLANDS)) {
            ...
            if (holder.m_203565_(Biomes.FROZEN_OCEAN) || holder.m_203565_(Biomes.DEEP_FROZEN_OCEAN)) {
               this.frozenOceanExtension(surfacerules$context.getMinSurfaceLevel(), holder.m_203334_(), blockcolumn, blockpos$mutableblockpos1, i1, j1, k1);
            }
         }
      }
