...
public class LakeFeature extends Feature<LakeFeature.Configuration> {
   ...
   public boolean place(FeaturePlaceContext<LakeFeature.Configuration> p_159958_) {
      ...
      if (blockpos.getY() <= worldgenlevel.getMinBuildHeight() + 4) {
               ...
               for(int j3 = 0; j3 < 16; ++j3) {
                  for(int l3 = 0; l3 < 8; ++l3) {
                     ...
                     if (flag2 && (l3 < 4 || random.nextInt(2) != 0)) {
                        ...
                        if (blockstate.getMaterial().isSolid() && !blockstate.m_204336_(BlockTags.LAVA_POOL_STONE_CANNOT_REPLACE)) {
         ...
         if (blockstate1.getFluidState().m_205070_(FluidTags.WATER)) {
            for(int k2 = 0; k2 < 16; ++k2) {
               for(int k3 = 0; k3 < 16; ++k3) {
                  int i4 = 4;
                  BlockPos blockpos2 = blockpos.offset(k2, 4, k3);
                  if (worldgenlevel.m_204166_(blockpos2).m_203334_().shouldFreeze(worldgenlevel, blockpos2, false) && this.canReplaceBlock(worldgenlevel.getBlockState(blockpos2))) {
   ...
   private boolean canReplaceBlock(BlockState p_190952_) {
      return !p_190952_.m_204336_(BlockTags.FEATURES_CANNOT_REPLACE);
   }
