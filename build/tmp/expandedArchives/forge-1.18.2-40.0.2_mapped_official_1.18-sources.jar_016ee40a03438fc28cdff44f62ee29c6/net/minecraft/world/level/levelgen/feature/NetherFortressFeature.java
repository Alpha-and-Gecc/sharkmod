...
public class NetherFortressFeature extends StructureFeature<NoneFeatureConfiguration> {
   ...
   private static boolean checkLocation(PieceGeneratorSupplier.Context<NoneFeatureConfiguration> p_197127_) {
      return p_197127_.validBiome().test(p_197127_.chunkGenerator().m_203495_(QuartPos.fromBlock(p_197127_.chunkPos().getMiddleBlockX()), QuartPos.fromBlock(64), QuartPos.fromBlock(p_197127_.chunkPos().getMiddleBlockZ())));
   }
