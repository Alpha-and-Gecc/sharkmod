...
public record TerrainShaper(CubicSpline<TerrainShaper.Point> offsetSampler, CubicSpline<TerrainShaper.Point> factorSampler, CubicSpline<TerrainShaper.Point> jaggednessSampler) {
   ...
   public static final Codec<CubicSpline<TerrainShaper.PointCustom>> f_211598_ = CubicSpline.codec(TerrainShaper.CoordinateCustom.f_211602_);
   ...
   public static TerrainShaper.PointCustom m_211599_(DensityFunction.FunctionContext p_211600_) {
   ...
   public static record CoordinateCustom(Holder<DensityFunction> f_211601_) implements ToFloatFunction<TerrainShaper.PointCustom> {
      static final Codec<ToFloatFunction<TerrainShaper.PointCustom>> f_211602_ = DensityFunction.f_208217_.flatComapMap(TerrainShaper.CoordinateCustom::new, (p_211608_) -> {
         DataResult dataresult;
         if (p_211608_ instanceof TerrainShaper.CoordinateCustom) {
            ...
            dataresult = DataResult.success(terrainshaper$coordinatecustom.f_211601_());
         } else {
      ...
      public TerrainShaper.CoordinateCustom m_211611_(DensityFunction.Visitor p_211612_) {
         return new TerrainShaper.CoordinateCustom(new Holder.Direct<>(this.f_211601_.m_203334_().m_207456_(p_211612_)));
      }
   }
   ...
   public static record PointCustom(DensityFunction.FunctionContext f_211619_) {
   }
}