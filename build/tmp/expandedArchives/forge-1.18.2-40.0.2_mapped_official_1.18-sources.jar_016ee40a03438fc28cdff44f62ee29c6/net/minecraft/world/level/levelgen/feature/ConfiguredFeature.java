...
public record ConfiguredFeature<FC extends FeatureConfiguration, F extends Feature<FC>>(F feature, FC config) {
   ...
   public static final Codec<HolderSet<ConfiguredFeature<?, ?>>> LIST_CODEC = RegistryCodecs.m_206279_(Registry.CONFIGURED_FEATURE_REGISTRY, DIRECT_CODEC);

   public boolean place(WorldGenLevel p_65386_, ChunkGenerator p_65387_, Random p_65388_, BlockPos p_65389_) {
      return this.feature.m_204740_(this.config, p_65386_, p_65387_, p_65388_, p_65389_);
   }
