...
public class WorldGenSettings {
   public static final Codec<WorldGenSettings> CODEC = RecordCodecBuilder.<WorldGenSettings>create((p_64626_) -> {
      return p_64626_.group(Codec.LONG.fieldOf("seed").stable().forGetter(WorldGenSettings::seed), Codec.BOOL.fieldOf("generate_features").orElse(true).stable().forGetter(WorldGenSettings::generateFeatures), Codec.BOOL.fieldOf("bonus_chest").orElse(false).stable().forGetter(WorldGenSettings::generateBonusChest), RegistryCodecs.m_206318_(Registry.LEVEL_STEM_REGISTRY, Lifecycle.stable(), LevelStem.CODEC).xmap(LevelStem::m_204525_, Function.identity()).fieldOf("dimensions").forGetter(WorldGenSettings::m_204655_), Codec.STRING.optionalFieldOf("legacy_custom_options").stable().forGetter((p_158959_) -> {
   ...
   private boolean stable() {
      return LevelStem.m_204522_(this.seed, this.dimensions);
   }
   ...
   public static WorldGenSettings demoSettings(RegistryAccess p_64646_) {
      ...
      return new WorldGenSettings((long)i, true, true, m_204649_(p_64646_.registryOrThrow(Registry.DIMENSION_TYPE_REGISTRY), DimensionType.m_204490_(p_64646_, (long)i), makeDefaultOverworld(p_64646_, (long)i)));
   }

   public static WorldGenSettings makeDefault(RegistryAccess p_190051_) {
      long i = (new Random()).nextLong();
      return new WorldGenSettings(i, true, false, m_204649_(p_190051_.registryOrThrow(Registry.DIMENSION_TYPE_REGISTRY), DimensionType.m_204490_(p_190051_, i), makeDefaultOverworld(p_190051_, i)));
   }
   ...
   public static NoiseBasedChunkGenerator makeOverworld(RegistryAccess p_190035_, long p_190036_, ResourceKey<NoiseGeneratorSettings> p_190037_, boolean p_190038_) {
      ...
      Registry<StructureSet> registry1 = p_190035_.registryOrThrow(Registry.f_211073_);
      ...
      return new NoiseBasedChunkGenerator(registry1, registry3, MultiNoiseBiomeSource.Preset.OVERWORLD.biomeSource(registry, p_190038_), p_190036_, registry2.m_203538_(p_190037_));
   }
   ...
   public static Registry<LevelStem> m_204649_(Registry<DimensionType> p_204650_, Registry<LevelStem> p_204651_, ChunkGenerator p_204652_) {
      ...
      Holder<DimensionType> holder = levelstem == null ? p_204650_.m_203538_(DimensionType.OVERWORLD_LOCATION) : levelstem.m_204521_();
      return m_204645_(p_204651_, holder, p_204652_);
   }
   ...
   public static Registry<LevelStem> m_204645_(Registry<LevelStem> p_204646_, Holder<DimensionType> p_204647_, ChunkGenerator p_204648_) {
      ...
      writableregistry.m_203505_(LevelStem.OVERWORLD, new LevelStem(p_204647_, p_204648_), Lifecycle.stable());

      for(Entry<ResourceKey<LevelStem>, LevelStem> entry : p_204646_.entrySet()) {
         ResourceKey<LevelStem> resourcekey = entry.getKey();
         if (resourcekey != LevelStem.OVERWORLD) {
            writableregistry.m_203505_(resourcekey, entry.getValue(), p_204646_.lifecycle(entry.getValue()));
         }
      }
   ...
   public ImmutableSet<ResourceKey<Level>> levels() {
      return this.m_204655_().entrySet().stream().map(Entry::getKey).map(WorldGenSettings::levelStemToLevel).collect(ImmutableSet.toImmutableSet());
   }
   ...
   public static WorldGenSettings m_209716_(RegistryAccess p_209717_, DedicatedServerProperties.WorldGenProperties p_209718_) {
      long i = m_202192_(p_209718_.f_207542_()).orElse((new Random()).nextLong());
      ...
      Registry<StructureSet> registry2 = p_209717_.registryOrThrow(Registry.f_211073_);
      Registry<LevelStem> registry3 = DimensionType.m_204490_(p_209717_, i);
      String s = p_209718_.f_207545_();
      net.minecraftforge.common.world.ForgeWorldPreset type = net.minecraftforge.registries.ForgeRegistries.WORLD_TYPES.getValue(new net.minecraft.resources.ResourceLocation(s));
      ...
      case "flat":
         ...
         return new WorldGenSettings(i, p_209718_.f_207544_(), false, m_204649_(registry, registry3, new FlatLevelSource(registry2, FlatLevelGeneratorSettings.CODEC.parse(dynamic).resultOrPartial(LOGGER::error).orElseGet(() -> {
            return FlatLevelGeneratorSettings.m_211734_(registry1, registry2);
         }))));
      case "debug_all_block_states":
         return new WorldGenSettings(i, p_209718_.f_207544_(), false, m_204649_(registry, registry3, new DebugLevelSource(registry2, registry1)));
      case "amplified":
         return new WorldGenSettings(i, p_209718_.f_207544_(), false, m_204649_(registry, registry3, makeOverworld(p_209717_, i, NoiseGeneratorSettings.AMPLIFIED)));
      case "largebiomes":
         return new WorldGenSettings(i, p_209718_.f_207544_(), false, m_204649_(registry, registry3, makeOverworld(p_209717_, i, NoiseGeneratorSettings.LARGE_BIOMES)));
      default:
         return new WorldGenSettings(i, p_209718_.f_207544_(), false, m_204649_(registry, registry3, makeDefaultOverworld(p_209717_, i)));
      }
   }
   ...
   public WorldGenSettings withSeed(boolean p_64655_, OptionalLong p_64656_) {
      ...
      if (p_64656_.isPresent()) {
         ...
         for(Entry<ResourceKey<LevelStem>, LevelStem> entry : this.dimensions.entrySet()) {
            ResourceKey<LevelStem> resourcekey = entry.getKey();
            writableregistry.m_203505_(resourcekey, new LevelStem(entry.getValue().m_204521_(), entry.getValue().generator().withSeed(j)), this.dimensions.lifecycle(entry.getValue()));
         }
