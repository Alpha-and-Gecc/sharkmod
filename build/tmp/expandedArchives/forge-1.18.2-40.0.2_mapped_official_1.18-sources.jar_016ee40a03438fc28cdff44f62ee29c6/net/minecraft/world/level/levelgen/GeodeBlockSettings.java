...
public class GeodeBlockSettings {
   ...
   public static final Codec<GeodeBlockSettings> CODEC = RecordCodecBuilder.create((p_158307_) -> {
      ...
      }), TagKey.m_203886_(Registry.BLOCK_REGISTRY).fieldOf("cannot_replace").forGetter((p_204566_) -> {
         return p_204566_.cannotReplace;
      }), TagKey.m_203886_(Registry.BLOCK_REGISTRY).fieldOf("invalid_blocks").forGetter((p_204564_) -> {
