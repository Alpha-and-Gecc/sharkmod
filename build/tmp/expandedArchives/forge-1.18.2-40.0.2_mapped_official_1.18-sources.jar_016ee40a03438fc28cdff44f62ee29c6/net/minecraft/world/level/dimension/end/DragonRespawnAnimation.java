         ...
         if (flag || flag1) {
            ...
            if (j < list.size()) {
               ...
               if (flag) {
                  ...
                  Feature.END_SPIKE.m_204740_(spikeconfiguration, p_64035_, p_64035_.getChunkSource().getGenerator(), new Random(), new BlockPos(spikefeature$endspike.getCenterX(), 45, spikefeature$endspike.getCenterZ()));
               }
            } else if (flag) {
