...
public class TagMatchTest extends RuleTest {
   public static final Codec<TagMatchTest> CODEC = TagKey.m_203877_(Registry.BLOCK_REGISTRY).fieldOf("tag").xmap(TagMatchTest::new, (p_205065_) -> {
   ...
   public boolean test(BlockState p_74697_, Random p_74698_) {
      return p_74697_.m_204336_(this.tag);
   }
