...
public class RuinedPortalFeature extends StructureFeature<RuinedPortalConfiguration> {
   ...
   private static Optional<PieceGenerator<RuinedPortalConfiguration>> pieceGeneratorSupplier(PieceGeneratorSupplier.Context<RuinedPortalConfiguration> p_197153_) {
      ...
      return !p_197153_.validBiome().test(p_197153_.chunkGenerator().m_203495_(QuartPos.fromBlock(blockpos3.getX()), QuartPos.fromBlock(blockpos3.getY()), QuartPos.fromBlock(blockpos3.getZ()))) ? Optional.empty() : Optional.of((p_197150_, p_197151_) -> {
         if (ruinedportalconfiguration.portalType == RuinedPortalFeature.Type.MOUNTAIN || ruinedportalconfiguration.portalType == RuinedPortalFeature.Type.OCEAN || ruinedportalconfiguration.portalType == RuinedPortalFeature.Type.STANDARD) {
            ruinedportalpiece$properties.cold = m_204763_(blockpos3, p_197153_.chunkGenerator().m_203495_(QuartPos.fromBlock(blockpos3.getX()), QuartPos.fromBlock(blockpos3.getY()), QuartPos.fromBlock(blockpos3.getZ())));
         }
   ...
   private static boolean m_204763_(BlockPos p_204764_, Holder<Biome> p_204765_) {
      return p_204765_.m_203334_().coldEnoughToSnow(p_204764_);
   }
