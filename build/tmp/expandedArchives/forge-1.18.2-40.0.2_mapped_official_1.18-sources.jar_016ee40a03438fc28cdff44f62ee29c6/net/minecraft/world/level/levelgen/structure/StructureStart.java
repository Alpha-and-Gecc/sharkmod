...
public final class StructureStart {
   ...
   public BoundingBox getBoundingBox() {
      ...
      if (boundingbox == null) {
         boundingbox = this.feature.m_209753_(this.pieceContainer.calculateBoundingBox());
   ...
   public CompoundTag createTag(StructurePieceSerializationContext p_192661_, ChunkPos p_192662_) {
      ...
      if (this.isValid()) {
         if (p_192661_.registryAccess().registryOrThrow(Registry.CONFIGURED_STRUCTURE_FEATURE_REGISTRY).getKey(this.m_210081_()) == null) { // FORGE: This is just a more friendly error instead of the 'Null String' below
            throw new RuntimeException("StructureStart \"" + this.getClass().getName() + "\": \"" + this.m_210081_() + "\" missing ID Mapping, Modder see MapGenStructureIO");
         }
