...
public class DimensionType {
   ...
   protected static final DimensionType DEFAULT_OVERWORLD = m_204497_(OptionalLong.empty(), true, false, false, true, 1.0D, false, false, true, false, true, -64, 384, 384, BlockTags.INFINIBURN_OVERWORLD, OVERWORLD_EFFECTS, 0.0F);
   protected static final DimensionType DEFAULT_NETHER = m_204497_(OptionalLong.of(18000L), false, true, true, false, 8.0D, false, true, false, true, false, 0, 256, 128, BlockTags.INFINIBURN_NETHER, NETHER_EFFECTS, 0.1F);
   protected static final DimensionType DEFAULT_END = m_204497_(OptionalLong.of(6000L), false, false, false, false, 1.0D, true, false, false, false, true, 0, 256, 256, BlockTags.INFINIBURN_END, END_EFFECTS, 0.0F);
   ...
   protected static final DimensionType DEFAULT_OVERWORLD_CAVES = m_204497_(OptionalLong.empty(), true, true, false, true, 1.0D, false, false, true, false, true, -64, 384, 384, BlockTags.INFINIBURN_OVERWORLD, OVERWORLD_EFFECTS, 0.0F);
   ...
   public static RegistryAccess.Writable m_204488_(RegistryAccess.Writable p_204489_) {
      WritableRegistry<DimensionType> writableregistry = p_204489_.m_206253_(Registry.DIMENSION_TYPE_REGISTRY);
      writableregistry.m_203505_(OVERWORLD_LOCATION, DEFAULT_OVERWORLD, Lifecycle.stable());
      writableregistry.m_203505_(OVERWORLD_CAVES_LOCATION, DEFAULT_OVERWORLD_CAVES, Lifecycle.stable());
      writableregistry.m_203505_(NETHER_LOCATION, DEFAULT_NETHER, Lifecycle.stable());
      writableregistry.m_203505_(END_LOCATION, DEFAULT_END, Lifecycle.stable());
      return p_204489_;
   }

   public static Registry<LevelStem> m_204490_(RegistryAccess p_204491_, long p_204492_) {
      return m_204493_(p_204491_, p_204492_, true);
   }

   public static Registry<LevelStem> m_204493_(RegistryAccess p_204494_, long p_204495_, boolean p_204496_) {
      ...
      Registry<StructureSet> registry2 = p_204494_.registryOrThrow(Registry.f_211073_);
      ...
      writableregistry.m_203505_(LevelStem.NETHER, new LevelStem(registry.m_203538_(NETHER_LOCATION), new NoiseBasedChunkGenerator(registry2, registry4, MultiNoiseBiomeSource.Preset.NETHER.biomeSource(registry1, p_204496_), p_204495_, registry3.m_203538_(NoiseGeneratorSettings.NETHER))), Lifecycle.stable());
      writableregistry.m_203505_(LevelStem.END, new LevelStem(registry.m_203538_(END_LOCATION), new NoiseBasedChunkGenerator(registry2, registry4, new TheEndBiomeSource(registry1, p_204495_), p_204495_, registry3.m_203538_(NoiseGeneratorSettings.END))), Lifecycle.stable());
