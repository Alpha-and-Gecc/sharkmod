...
public class BiomeGenerationSettings {
   ...
   public static final MapCodec<BiomeGenerationSettings> CODEC = RecordCodecBuilder.mapCodec((p_186655_) -> {
      ...
      }), PlacedFeature.f_204922_.promotePartial(Util.prefix("Features: ", LOGGER::error)).fieldOf("features").forGetter((p_186653_) -> {
   ...
   BiomeGenerationSettings(Map<GenerationStep.Carving, HolderSet<ConfiguredWorldCarver<?>>> p_186650_, List<HolderSet<PlacedFeature>> p_186651_) {
      ...
      this.flowerFeatures = Suppliers.memoize(() -> {
         return p_186651_.stream().flatMap(HolderSet::m_203614_).map(Holder::m_203334_).flatMap(PlacedFeature::getFeatures).filter((p_186657_) -> {
   ...
   public static class Builder {
      ...
      public BiomeGenerationSettings.Builder m_204201_(GenerationStep.Decoration p_204202_, Holder<PlacedFeature> p_204203_) {
         return this.m_204193_(p_204202_.ordinal(), p_204203_);
      }

      public BiomeGenerationSettings.Builder m_204193_(int p_204194_, Holder<PlacedFeature> p_204195_) {
         this.addFeatureStepsUpTo(p_204194_);
         this.features.get(p_204194_).add(p_204195_);
         return this;
      }

      public BiomeGenerationSettings.Builder m_204198_(GenerationStep.Carving p_204199_, Holder<? extends ConfiguredWorldCarver<?>> p_204200_) {
         this.carvers.computeIfAbsent(p_204199_, (p_204197_) -> {
            return Lists.newArrayList();
         }).add(Holder.m_205706_(p_204200_));
         return this;
      }
      ...
      public BiomeGenerationSettings build() {
         return new BiomeGenerationSettings(this.carvers.entrySet().stream().collect(ImmutableMap.toImmutableMap(Entry::getKey, (p_204205_) -> {
            return HolderSet.m_205800_(p_204205_.getValue());
         })), this.features.stream().map(HolderSet::m_205800_).collect(ImmutableList.toImmutableList()));
      }
   }
}
