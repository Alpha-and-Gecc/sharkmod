...
public class StructureCheck {
   ...
   public StructureCheck(ChunkScanAccess p_197251_, RegistryAccess p_197252_, StructureManager p_197253_, ResourceKey<Level> p_197254_, ChunkGenerator p_197255_, LevelHeightAccessor p_197256_, BiomeSource p_197257_, long p_197258_, DataFixer p_197259_) {
      ...
      this.biomes = p_197252_.m_206191_(Registry.BIOME_REGISTRY);
      this.f_204945_ = p_197252_.m_206191_(Registry.CONFIGURED_STRUCTURE_FEATURE_REGISTRY);
   }

   public StructureCheckResult m_209964_(ChunkPos p_209965_, ConfiguredStructureFeature<?, ?> p_209966_, boolean p_209967_) {
      long i = p_209965_.toLong();
      Object2IntMap<ConfiguredStructureFeature<?, ?>> object2intmap = this.loadedChunks.get(i);
      if (object2intmap != null) {
         return this.m_209986_(object2intmap, p_209966_, p_209967_);
      } else {
         StructureCheckResult structurecheckresult = this.m_209968_(p_209965_, p_209966_, p_209967_, i);
         if (structurecheckresult != null) {
            ...
            boolean flag = this.featureChecks.computeIfAbsent(p_209966_, (p_209974_) -> {
               ...
               return this.m_209990_(p_209965_, p_209966_);
            });
   ...
   private <FC extends FeatureConfiguration, F extends StructureFeature<FC>> boolean m_209990_(ChunkPos p_209991_, ConfiguredStructureFeature<FC, F> p_209992_) {
      return p_209992_.feature.canGenerate(this.registryAccess, this.chunkGenerator, this.biomeSource, this.structureManager, this.seed, p_209991_, p_209992_.config, this.heightAccessor, p_209992_.m_209752_()::m_203333_);
   }

   @Nullable
   private StructureCheckResult m_209968_(ChunkPos p_209969_, ConfiguredStructureFeature<?, ?> p_209970_, boolean p_209971_, long p_209972_) {
      ...
      if (!(tag instanceof CompoundTag)) {
         ...
         if (i <= 1493) {
            ...
            if (object2intmap == null) {
               ...
               return this.m_209986_(object2intmap, p_209970_, p_209971_);
            }
         }
      }
   }
   ...
   private StructureCheckResult m_209986_(Object2IntMap<ConfiguredStructureFeature<?, ?>> p_209987_, ConfiguredStructureFeature<?, ?> p_209988_, boolean p_209989_) {
   ...
   public void m_209957_(ChunkPos p_209958_, ConfiguredStructureFeature<?, ?> p_209959_) {
