...
public class SurfaceRules {
   public static final SurfaceRules.ConditionSource ON_FLOOR = m_202176_(0, false, CaveSurface.FLOOR);
   public static final SurfaceRules.ConditionSource UNDER_FLOOR = m_202176_(0, true, CaveSurface.FLOOR);
   public static final SurfaceRules.ConditionSource f_202169_ = m_202171_(0, true, 6, CaveSurface.FLOOR);
   public static final SurfaceRules.ConditionSource f_202170_ = m_202171_(0, true, 30, CaveSurface.FLOOR);
   public static final SurfaceRules.ConditionSource ON_CEILING = m_202176_(0, false, CaveSurface.CEILING);
   public static final SurfaceRules.ConditionSource UNDER_CEILING = m_202176_(0, true, CaveSurface.CEILING);

   public static SurfaceRules.ConditionSource m_202176_(int p_202177_, boolean p_202178_, CaveSurface p_202179_) {
      return new SurfaceRules.StoneDepthCheck(p_202177_, p_202178_, 0, p_202179_);
   }

   public static SurfaceRules.ConditionSource m_202171_(int p_202172_, boolean p_202173_, int p_202174_, CaveSurface p_202175_) {
      ...
      public SurfaceRules.Condition apply(final SurfaceRules.Context p_189496_) {
         class BiomeCondition extends SurfaceRules.LazyYCondition {
            ...
            protected boolean compute() {
               return this.context.biome.get().m_203425_(BiomeConditionSource.this.f_204618_);
            }
         }
   ...
   public interface ConditionSource extends Function<SurfaceRules.Context, SurfaceRules.Condition> {
      ...
      static Codec<? extends SurfaceRules.ConditionSource> m_204624_(Registry<Codec<? extends SurfaceRules.ConditionSource>> p_204625_) {
   ...
   protected static final class Context {
      ...
      protected double m_202181_() {
         if (this.lastSurfaceDepth2Update != this.lastUpdateXZ) {
            ...
            this.f_202180_ = this.system.m_202189_(this.blockX, this.blockZ);
         }
      ...
      static class TemperatureHelperCondition extends SurfaceRules.LazyYCondition {
         ...
         protected boolean compute() {
            return this.context.biome.get().m_203334_().coldEnoughToSnow(this.context.pos.set(this.context.blockX, this.context.blockY, this.context.blockZ));
         }
      }
   }
   ...
   public interface RuleSource extends Function<SurfaceRules.Context, SurfaceRules.SurfaceRule> {
      ...
      static Codec<? extends SurfaceRules.RuleSource> m_204630_(Registry<Codec<? extends SurfaceRules.RuleSource>> p_204631_) {
      ...
      public SurfaceRules.Condition apply(final SurfaceRules.Context p_189755_) {
         ...
         class StoneDepthCondition extends SurfaceRules.LazyYCondition {
            ...
            protected boolean compute() {
               ...
               int k = StoneDepthCheck.this.f_202182_ == 0 ? 0 : (int)Mth.map(this.context.m_202181_(), -1.0D, 1.0D, 0.0D, (double)StoneDepthCheck.this.f_202182_);
