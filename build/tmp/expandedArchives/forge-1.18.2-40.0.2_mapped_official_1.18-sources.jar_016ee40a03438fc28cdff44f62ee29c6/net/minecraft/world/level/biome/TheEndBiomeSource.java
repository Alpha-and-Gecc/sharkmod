...
public class TheEndBiomeSource extends BiomeSource {
   public static final Codec<TheEndBiomeSource> CODEC = RecordCodecBuilder.create((p_48644_) -> {
      return p_48644_.group(RegistryOps.m_206832_(Registry.BIOME_REGISTRY).forGetter((p_151890_) -> {
         return null;
   ...
   public TheEndBiomeSource(Registry<Biome> p_48628_, long p_48629_) {
      this(p_48629_, p_48628_.m_203538_(Biomes.THE_END), p_48628_.m_203538_(Biomes.END_HIGHLANDS), p_48628_.m_203538_(Biomes.END_MIDLANDS), p_48628_.m_203538_(Biomes.SMALL_END_ISLANDS), p_48628_.m_203538_(Biomes.END_BARRENS));
   }
