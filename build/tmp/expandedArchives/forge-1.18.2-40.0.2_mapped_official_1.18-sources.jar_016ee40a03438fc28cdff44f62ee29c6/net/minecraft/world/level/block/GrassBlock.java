      ...
      for(int i = 0; i < 128; ++i) {
         ...
         if (blockstate1.isAir()) {
            ...
            if (p_53688_.nextInt(8) == 0) {
               List<ConfiguredFeature<?, ?>> list = p_53687_.m_204166_(blockpos1).m_203334_().getGenerationSettings().getFlowerFeatures();
               if (list.isEmpty()) {
                  continue;
               }
            ...
            holder.m_203334_().place(p_53687_, p_53687_.getChunkSource().getGenerator(), p_53688_, blockpos1);
         }
      }
