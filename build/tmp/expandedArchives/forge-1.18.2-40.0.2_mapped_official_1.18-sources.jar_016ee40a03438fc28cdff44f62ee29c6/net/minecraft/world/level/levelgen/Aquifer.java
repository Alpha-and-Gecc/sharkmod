...
public interface Aquifer {
   static Aquifer m_208160_(NoiseChunk p_208161_, ChunkPos p_208162_, DensityFunction p_208163_, DensityFunction p_208164_, DensityFunction p_208165_, DensityFunction p_208166_, PositionalRandomFactory p_208167_, int p_208168_, int p_208169_, Aquifer.FluidPicker p_208170_) {
   ...
   static Aquifer createDisabled(final Aquifer.FluidPicker p_188375_) {
      return new Aquifer() {
         ...
         public BlockState m_207104_(DensityFunction.FunctionContext p_208172_, double p_208173_) {
            return p_208173_ > 0.0D ? null : p_188375_.computeFluid(p_208172_.m_207115_(), p_208172_.m_207114_(), p_208172_.m_207113_()).at(p_208172_.m_207114_());
         }
   ...
   @Nullable
   BlockState m_207104_(DensityFunction.FunctionContext p_208158_, double p_208159_);
   ...
   public static class NoiseBasedAquifer implements Aquifer {
         ...
         if ((!blockstate.is(Blocks.LAVA) || !blockstate1.is(Blocks.WATER)) && (!blockstate.is(Blocks.WATER) || !blockstate1.is(Blocks.LAVA))) {
            ...
            if (j == 0) {
               ...
               if (!(d10 < -2.0D) && !(d10 > 2.0D)) {
                  ...
                  if (Double.isNaN(d13)) {
                     double d14 = this.barrierNoise.m_207386_(p_208189_);
      ...
      private Aquifer.FluidStatus m_188447_(int p_188448_, int p_188449_, int p_188450_) {
         ...
         double d3 = Mth.clamp(this.fluidLevelFloodednessNoise.m_207386_(new DensityFunction.SinglePointContext(p_188448_, p_188449_, p_188450_)), -1.0D, 1.0D);
         ...
         if (d3 > d4) {
            ...
            if (d3 <= d5) {
               ...
               int l2 = j2 * 40 + 20;
               int i3 = 10;
               double d0 = this.fluidLevelSpreadNoise.m_207386_(new DensityFunction.SinglePointContext(i2, j2, k2)) * 10.0D;
               ...
               if (k3 <= -10) {
                  ...
                  double d1 = this.lavaNoise.m_207386_(new DensityFunction.SinglePointContext(k4, l4, i5));
                  if (Math.abs(d1) > 0.3D) {
