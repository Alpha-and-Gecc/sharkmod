...
public class Noises {
   ...
   public static NormalNoise instantiate(Registry<NormalNoise.NoiseParameters> p_189306_, PositionalRandomFactory p_189307_, ResourceKey<NormalNoise.NoiseParameters> p_189308_) {
      Holder<NormalNoise.NoiseParameters> holder = p_189306_.m_206081_(p_189308_);
      return m_209647_(p_189307_, holder);
   }

   public static NormalNoise m_209647_(PositionalRandomFactory p_209648_, Holder<NormalNoise.NoiseParameters> p_209649_) {
      return NormalNoise.create(p_209648_.fromHashOf(p_209649_.m_203543_().orElseThrow().location()), p_209649_.m_203334_());
   }
}