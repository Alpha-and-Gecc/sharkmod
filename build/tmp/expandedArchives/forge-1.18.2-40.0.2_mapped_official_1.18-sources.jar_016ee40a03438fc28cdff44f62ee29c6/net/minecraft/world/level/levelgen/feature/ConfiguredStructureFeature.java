...
public class ConfiguredStructureFeature<FC extends FeatureConfiguration, F extends StructureFeature<FC>> {
   ...
   public static final Codec<HolderSet<ConfiguredStructureFeature<?, ?>>> LIST_CODEC = RegistryCodecs.m_206279_(Registry.CONFIGURED_STRUCTURE_FEATURE_REGISTRY, DIRECT_CODEC);
   ...
   public ConfiguredStructureFeature(F p_209747_, FC p_209748_, HolderSet<Biome> p_209749_, boolean p_209750_, Map<MobCategory, StructureSpawnOverride> p_209751_) {
      ...
      this.f_209743_ = p_209749_;
      this.f_209745_ = p_209750_;
      this.f_209744_ = p_209751_;
   }

   public StructureStart m_204707_(RegistryAccess p_204708_, ChunkGenerator p_204709_, BiomeSource p_204710_, StructureManager p_204711_, long p_204712_, ChunkPos p_204713_, int p_204714_, LevelHeightAccessor p_204715_, Predicate<Holder<Biome>> p_204716_) {
      Optional<PieceGenerator<FC>> optional = this.feature.m_209787_().createGenerator(new PieceGeneratorSupplier.Context<>(p_204709_, p_204710_, p_204712_, p_204713_, this.config, p_204715_, p_204716_, p_204711_, p_204708_));
   ...
   public BoundingBox m_209753_(BoundingBox p_209754_) {
      return this.f_209745_ ? p_209754_.inflatedBy(12) : p_209754_;
   }
}