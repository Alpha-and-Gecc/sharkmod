...
public class LevelChunkSection {
   ...
   public LevelChunkSection(int p_188001_, Registry<Biome> p_188002_) {
      ...
      this.biomes = new PalettedContainer<>(p_188002_.m_206115_(), p_188002_.m_206081_(Biomes.PLAINS), PalettedContainer.Strategy.SECTION_BIOMES);
   }
   ...
   public void recalcBlockCounts() {
      ...
      this.nonEmptyBlockCount = (short)levelchunksection$1blockcounter.f_204437_;
      this.tickingBlockCount = (short)levelchunksection$1blockcounter.f_204438_;
      this.tickingFluidCount = (short)levelchunksection$1blockcounter.f_204439_;
   }
         ...
         for(int k = 0; k < 4; ++k) {
            for(int l = 0; l < 4; ++l) {
               for(int i1 = 0; i1 < 4; ++i1) {
                  palettedcontainer.getAndSetUnchecked(k, l, i1, p_188004_.m_203407_(p_188006_ + k, i + l, p_188007_ + i1, p_188005_));
               }
            }
         }
      } finally {
