...
public class PoolElementStructurePiece extends StructurePiece {
   ...
   public PoolElementStructurePiece(StructureManager p_209910_, StructurePoolElement p_209911_, BlockPos p_209912_, int p_209913_, Rotation p_209914_, BoundingBox p_209915_) {
      super(StructurePieceType.f_210125_, 0, p_209915_);
   ...
   public PoolElementStructurePiece(StructurePieceSerializationContext p_192406_, CompoundTag p_192407_) {
      ...
      DynamicOps<Tag> dynamicops = RegistryOps.m_206821_(NbtOps.INSTANCE, p_192406_.registryAccess());
      this.element = StructurePoolElement.f_210468_.parse(dynamicops, p_192407_.getCompound("pool_element")).resultOrPartial(LOGGER::error).orElseThrow(() -> {
         return new IllegalStateException("Invalid pool element found");
      });
      this.rotation = Rotation.valueOf(p_192407_.getString("rotation"));
      this.boundingBox = this.element.m_207470_(this.structureManager, this.position, this.rotation);
      ListTag listtag = p_192407_.getList("junctions", 10);
      this.junctions.clear();
      listtag.forEach((p_204943_) -> {
         this.junctions.add(JigsawJunction.m_210253_(new Dynamic<>(dynamicops, p_204943_)));
      });
   }
   ...
   protected void addAdditionalSaveData(StructurePieceSerializationContext p_192425_, CompoundTag p_192426_) {
      ...
      DynamicOps<Tag> dynamicops = RegistryOps.m_206821_(NbtOps.INSTANCE, p_192425_.registryAccess());
      StructurePoolElement.f_210468_.encodeStart(dynamicops, this.element).resultOrPartial(LOGGER::error).ifPresent((p_163125_) -> {
      ...
      for(JigsawJunction jigsawjunction : this.junctions) {
         listtag.add(jigsawjunction.m_210255_(dynamicops).getValue());
      }
   ...
   public void place(WorldGenLevel p_192417_, StructureFeatureManager p_192418_, ChunkGenerator p_192419_, Random p_192420_, BoundingBox p_192421_, BlockPos p_192422_, boolean p_192423_) {
      this.element.m_207251_(this.structureManager, p_192417_, p_192418_, p_192419_, this.position, p_192422_, this.rotation, p_192421_, p_192420_, p_192423_);
   }
