...
public abstract class StructureFeature<C extends FeatureConfiguration> extends net.minecraftforge.registries.ForgeRegistryEntry<StructureFeature<?>> {
   ...
   public static final StructureFeature<NoneFeatureConfiguration> f_209756_ = register("fortress", new NetherFortressFeature(NoneFeatureConfiguration.CODEC), GenerationStep.Decoration.UNDERGROUND_DECORATION);
   ...
   public StructureFeature(Codec<C> p_197168_, PieceGeneratorSupplier<C> p_197169_, PostPlacementProcessor p_197170_) {
      this.configuredStructureCodec = RecordCodecBuilder.create((p_209759_) -> {
         ...
         }), RegistryCodecs.m_206277_(Registry.BIOME_REGISTRY).fieldOf("biomes").forGetter(ConfiguredStructureFeature::m_209752_), Codec.BOOL.optionalFieldOf("adapt_noise", Boolean.valueOf(false)).forGetter((p_209784_) -> {
            return p_209784_.f_209745_;
         }), Codec.simpleMap(MobCategory.CODEC, StructureSpawnOverride.f_210042_, StringRepresentable.keys(MobCategory.values())).fieldOf("spawn_overrides").forGetter((p_209761_) -> {
            return p_209761_.f_209744_;
   ...
   public ConfiguredStructureFeature<C, ? extends StructureFeature<C>> m_209769_(C p_209770_, TagKey<Biome> p_209771_, boolean p_209772_) {
      return new ConfiguredStructureFeature<>(this, p_209770_, BuiltinRegistries.BIOME.m_203561_(p_209771_), p_209772_, Map.of());
   }
   ...
   public ConfiguredStructureFeature<C, ? extends StructureFeature<C>> m_209765_(C p_209766_, TagKey<Biome> p_209767_, Map<MobCategory, StructureSpawnOverride> p_209768_) {
      return new ConfiguredStructureFeature<>(this, p_209766_, BuiltinRegistries.BIOME.m_203561_(p_209767_), false, p_209768_);
   }
   ...
   public ConfiguredStructureFeature<C, ? extends StructureFeature<C>> m_209773_(C p_209774_, TagKey<Biome> p_209775_, boolean p_209776_, Map<MobCategory, StructureSpawnOverride> p_209777_) {
      return new ConfiguredStructureFeature<>(this, p_209774_, BuiltinRegistries.BIOME.m_203561_(p_209775_), p_209776_, p_209777_);
   }

   public static BlockPos m_204766_(RandomSpreadStructurePlacement p_204767_, ChunkPos p_204768_) {
      return (new BlockPos(p_204768_.getMinBlockX(), 0, p_204768_.getMinBlockZ())).offset(p_204767_.f_204977_());
   }
