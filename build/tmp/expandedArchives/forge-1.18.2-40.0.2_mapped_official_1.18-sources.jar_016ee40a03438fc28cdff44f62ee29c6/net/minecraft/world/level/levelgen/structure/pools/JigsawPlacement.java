...
public class JigsawPlacement {
   ...
   public static Optional<PieceGenerator<JigsawConfiguration>> m_210284_(PieceGeneratorSupplier.Context<JigsawConfiguration> p_210285_, JigsawPlacement.PieceFactory p_210286_, BlockPos p_210287_, boolean p_210288_, boolean p_210289_) {
      ...
      StructureTemplatePool structuretemplatepool = jigsawconfiguration.m_204802_().m_203334_();
         ...
         if (!predicate.test(chunkgenerator.m_203495_(QuartPos.fromBlock(i), QuartPos.fromBlock(k), QuartPos.fromBlock(j)))) {
            ...
            return Optional.of((p_210282_, p_210283_) -> {
               ...
               if (jigsawconfiguration.maxDepth() > 0) {
                  ...
                  jigsawplacement$placer.f_210321_.addLast(new JigsawPlacement.PieceState(poolelementstructurepiece, new MutableObject<>(Shapes.join(Shapes.create(aabb), Shapes.create(AABB.of(boundingbox)), BooleanOp.ONLY_FIRST)), 0));

                  while(!jigsawplacement$placer.f_210321_.isEmpty()) {
                     JigsawPlacement.PieceState jigsawplacement$piecestate = jigsawplacement$placer.f_210321_.removeFirst();
   ...
   public static void m_210290_(RegistryAccess p_210291_, PoolElementStructurePiece p_210292_, int p_210293_, JigsawPlacement.PieceFactory p_210294_, ChunkGenerator p_210295_, StructureManager p_210296_, List<? super PoolElementStructurePiece> p_210297_, Random p_210298_, LevelHeightAccessor p_210299_) {
      ...
      jigsawplacement$placer.f_210321_.addLast(new JigsawPlacement.PieceState(p_210292_, new MutableObject<>(Shapes.INFINITY), 0));
   ...
   static final class Placer {
      ...
      private final JigsawPlacement.PieceFactory f_210316_;
         ...
         for(StructureTemplate.StructureBlockInfo structuretemplate$structureblockinfo : structurepoolelement.m_207245_(this.f_210318_, blockpos, rotation, this.f_210320_)) {
            ...
            if (optional.isPresent() && (optional.get().m_210590_() != 0 || Objects.equals(resourcelocation, Pools.EMPTY.location()))) {
               ...
               if (optional1.isPresent() && (optional1.get().m_210590_() != 0 || Objects.equals(resourcelocation1, Pools.EMPTY.location()))) {
                           ...
                           if (JigsawBlock.canAttach(structuretemplate$structureblockinfo, structuretemplate$structureblockinfo1)) {
                              ...
                              if (!Shapes.joinIsNotEmpty(mutableobject1.getValue(), Shapes.create(AABB.of(boundingbox3).deflate(0.25D)), BooleanOp.ONLY_SECOND)) {
                                 ...
                                 if (p_210336_ + 1 <= this.f_210315_) {
                                    this.f_210321_.addLast(new JigsawPlacement.PieceState(poolelementstructurepiece, mutableobject1, p_210336_ + 1));
                                 }
                                 continue label139;
                              }
                           }
                  ...
                  JigsawPlacement.f_210265_.warn("Empty or non-existent fallback pool: {}", (Object)resourcelocation1);
               }
            } else {
               JigsawPlacement.f_210265_.warn("Empty or non-existent pool: {}", (Object)resourcelocation);
            }
         }
