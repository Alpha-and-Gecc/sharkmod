...
public class Beardifier implements DensityFunctions.BeardifierOrMarker {
   ...
   protected Beardifier(StructureFeatureManager p_158070_, ChunkAccess p_158071_) {
      ...
      p_158070_.m_207811_(SectionPos.bottomOf(p_158071_), (p_208202_) -> {
         return p_208202_.f_209745_;
      }).forEach((p_208198_) -> {
   ...
   public double m_207386_(DensityFunction.FunctionContext p_208200_) {
      ...
      while(this.junctionIterator.hasNext()) {
         ...
         int k1 = i - jigsawjunction.m_210252_();
         int l1 = j - jigsawjunction.m_210257_();
         int i2 = k - jigsawjunction.m_210258_();
