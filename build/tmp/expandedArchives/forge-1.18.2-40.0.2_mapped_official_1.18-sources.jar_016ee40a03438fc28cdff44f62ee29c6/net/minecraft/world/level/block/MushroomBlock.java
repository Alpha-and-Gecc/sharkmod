...
public class MushroomBlock extends BushBlock implements BonemealableBlock {
   ...
   public boolean canSurvive(BlockState p_54880_, LevelReader p_54881_, BlockPos p_54882_) {
      ...
      if (blockstate.m_204336_(BlockTags.MUSHROOM_GROW_BLOCK)) {
         return true;
      } else {
   ...
   public boolean growMushroom(ServerLevel p_54860_, BlockPos p_54861_, BlockState p_54862_, Random p_54863_) {
      ...
      if (this.featureSupplier.get().m_203334_().place(p_54860_, p_54860_.getChunkSource().getGenerator(), p_54863_, p_54861_)) {
         return true;
      } else {
