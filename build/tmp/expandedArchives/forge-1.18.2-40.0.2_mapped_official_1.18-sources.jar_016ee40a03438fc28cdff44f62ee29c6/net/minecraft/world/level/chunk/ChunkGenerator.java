...
public abstract class ChunkGenerator implements BiomeManager.NoiseBiomeSource {
   ...
   private void m_208097_() {
      Set<Holder<Biome>> set = this.runtimeBiomeSource.m_207840_();
   ...
   private CompletableFuture<List<ChunkPos>> m_211667_(Holder<StructureSet> p_211668_, ConcentricRingsStructurePlacement p_211669_) {
      return p_211669_.f_204952_() == 0 ? CompletableFuture.completedFuture(List.of()) : CompletableFuture.supplyAsync(Util.wrapThreadWithTaskName("placement calculation", () -> {
         ...
         for(int j1 = 0; j1 < j; ++j1) {
            ...
            Pair<BlockPos, Holder<Biome>> pair = this.biomeSource.m_207829_(SectionPos.sectionToBlockCoord(k1, 8), 0, SectionPos.sectionToBlockCoord(l1, 8), 112, set::contains, random, this.climateSampler());
            if (pair != null) {
   ...
   public CompletableFuture<ChunkAccess> createBiomes(Registry<Biome> p_196743_, Executor p_196744_, Blender p_196745_, StructureFeatureManager p_196746_, ChunkAccess p_196747_) {
      return CompletableFuture.supplyAsync(Util.wrapThreadWithTaskName("init_biomes", () -> {
         p_196747_.fillBiomesFromNoise(this.runtimeBiomeSource::m_203407_, this.climateSampler());
         return p_196747_;
      }), Util.backgroundExecutor());
   }
   ...
   public Holder<Biome> m_203495_(int p_204416_, int p_204417_, int p_204418_) {
      return this.getBiomeSource().m_203407_(p_204416_, p_204417_, p_204418_, this.climateSampler());
   }
   ...
   public Pair<BlockPos, Holder<ConfiguredStructureFeature<?, ?>>> m_207970_(ServerLevel p_207971_, HolderSet<ConfiguredStructureFeature<?, ?>> p_207972_, BlockPos p_207973_, int p_207974_, boolean p_207975_) {
      ...
      if (set.isEmpty()) {
         ...
         Set<Holder<Biome>> set1 = this.runtimeBiomeSource.m_207840_();
            ...
            if (!list.isEmpty()) {
               ...
               for(int k = 0; k <= p_207974_; ++k) {
                  ...
                  for(Entry<StructurePlacement, Set<Holder<ConfiguredStructureFeature<?, ?>>>> entry1 : list) {
                     ...
                     Pair<BlockPos, Holder<ConfiguredStructureFeature<?, ?>>> pair1 = m_208059_(entry1.getValue(), p_207971_, p_207971_.structureFeatureManager(), i, j, k, p_207975_, p_207971_.getSeed(), randomspreadstructureplacement);
                     if (pair1 != null) {
                        flag = true;
            ...
            if (flag || flag1) {
               ...
               for(Holder<ConfiguredStructureFeature<?, ?>> holder : p_208060_) {
                  ...
                  if (structurecheckresult != StructureCheckResult.START_NOT_PRESENT) {
                     ...
                     StructureStart structurestart = p_208062_.m_207802_(SectionPos.bottomOf(chunkaccess), holder.m_203334_(), chunkaccess);
                     if (structurestart != null && structurestart.isValid()) {
                        if (p_208066_ && structurestart.canBeReferenced()) {
                           p_208062_.addReference(structurestart);
                           return Pair.of(StructureFeature.m_204766_(p_208068_, structurestart.getChunkPos()), holder);
                        }
   ...
   public void applyBiomeDecoration(WorldGenLevel p_187712_, ChunkAccess p_187713_, StructureFeatureManager p_187714_) {
      ...
      if (!SharedConstants.debugVoidTerrain(chunkpos)) {
         ...
         if (this instanceof FlatLevelSource) {
            this.biomeSource.m_207840_().stream().map(Holder::m_203334_).forEach(set::add);
         } else {
            ...
            set.retainAll(this.biomeSource.m_207840_().stream().map(Holder::m_203334_).collect(Collectors.toSet()));
         }
   ...
   public boolean m_212265_(ResourceKey<StructureSet> p_212266_, long p_212267_, int p_212268_, int p_212269_, int p_212270_) {
      StructureSet structureset = this.f_207955_.get(p_212266_);
   ...
   public WeightedRandomList<MobSpawnSettings.SpawnerData> m_203315_(Holder<Biome> p_204386_, StructureFeatureManager p_204387_, MobCategory p_204388_, BlockPos p_204389_) {
      ...
      return p_204386_.m_203334_().getMobSettings().getMobs(p_204388_);
   }
   ...
   public void createStructures(RegistryAccess p_62200_, StructureFeatureManager p_62201_, ChunkAccess p_62202_, StructureManager p_62203_, long p_62204_) {
      ...
      this.m_207969_().forEach((p_212264_) -> {
         ...
         if (structureplacement.m_212129_(this, p_62204_, chunkpos.x, chunkpos.z)) {
            if (list.size() == 1) {
   ...
   private boolean m_208016_(StructureSet.StructureSelectionEntry p_208017_, StructureFeatureManager p_208018_, RegistryAccess p_208019_, StructureManager p_208020_, long p_208021_, ChunkAccess p_208022_, ChunkPos p_208023_, SectionPos p_208024_) {
      ...
      StructureStart structurestart = configuredstructurefeature.m_204707_(p_208019_, this, this.biomeSource, p_208020_, p_208021_, p_208023_, i, p_208022_, predicate);
               ...
               try {
                  ...
                  crashreportcategory.setDetail("Id", () -> {
                     return optional.map((p_211661_) -> {
                        return p_211661_.getKey(structurestart.m_210081_()).toString();
                     }).orElse("UNKNOWN");
                  });
                  crashreportcategory.setDetail("Name", () -> {
                     return Registry.STRUCTURE_FEATURE.getKey(structurestart.m_210081_().feature).toString();
                  });
