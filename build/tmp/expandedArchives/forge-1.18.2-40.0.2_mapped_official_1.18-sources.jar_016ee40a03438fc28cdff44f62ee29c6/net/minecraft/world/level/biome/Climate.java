...
public class Climate {
   ...
   public static Climate.Sampler m_207841_() {
      DensityFunction densityfunction = DensityFunctions.m_208263_();
   ...
   public static BlockPos m_207842_(List<Climate.ParameterPoint> p_207843_, Climate.Sampler p_207844_) {
   ...
   public static class ParameterList<T> {
      ...
      public T m_204252_(Climate.TargetPoint p_204253_) {
         return this.findValueIndex(p_204253_);
      }

      @VisibleForTesting
      public T m_204254_(Climate.TargetPoint p_204255_) {
   ...
   public static record Sampler(DensityFunction f_207845_, DensityFunction f_207846_, DensityFunction f_207847_, DensityFunction f_207848_, DensityFunction f_207849_, DensityFunction f_207850_, List<Climate.ParameterPoint> f_207851_) {
      public Climate.TargetPoint sample(int p_186975_, int p_186976_, int p_186977_) {
         ...
         return Climate.target((float)this.f_207845_.m_207386_(densityfunction$singlepointcontext), (float)this.f_207846_.m_207386_(densityfunction$singlepointcontext), (float)this.f_207847_.m_207386_(densityfunction$singlepointcontext), (float)this.f_207848_.m_207386_(densityfunction$singlepointcontext), (float)this.f_207849_.m_207386_(densityfunction$singlepointcontext), (float)this.f_207850_.m_207386_(densityfunction$singlepointcontext));
      }

      public BlockPos findSpawnPosition() {
         return this.f_207851_.isEmpty() ? BlockPos.ZERO : Climate.m_207842_(this.f_207851_, this);
      }
   }
   ...
   static class SpawnFinder {
      ...
      SpawnFinder(List<Climate.ParameterPoint> p_207872_, Climate.Sampler p_207873_) {
         this.result = m_207879_(p_207872_, p_207873_, 0, 0);
         this.m_207874_(p_207872_, p_207873_, 2048.0F, 512.0F);
         this.m_207874_(p_207872_, p_207873_, 512.0F, 32.0F);
      }

      private void m_207874_(List<Climate.ParameterPoint> p_207875_, Climate.Sampler p_207876_, float p_207877_, float p_207878_) {
         float f = 0.0F;
         float f1 = p_207878_;
