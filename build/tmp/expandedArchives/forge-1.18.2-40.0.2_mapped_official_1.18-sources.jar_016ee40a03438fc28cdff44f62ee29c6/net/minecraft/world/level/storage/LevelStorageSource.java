...
public class LevelStorageSource {
   ...
   private static Tag m_202312_(File p_202313_) throws IOException {
      ...
      NbtIo.m_202487_(p_202313_, skipfields);
   ...
   public class LevelStorageAccess implements AutoCloseable {
      ...
      public WorldData m_211747_(DynamicOps<Tag> p_211748_, DataPackConfig p_211749_, Lifecycle p_211750_) {
         this.checkLock();
         return LevelStorageSource.this.readLevelData(this.levelPath.toFile(), LevelStorageSource.m_211737_(p_211748_, p_211749_, p_211750_));
      }
