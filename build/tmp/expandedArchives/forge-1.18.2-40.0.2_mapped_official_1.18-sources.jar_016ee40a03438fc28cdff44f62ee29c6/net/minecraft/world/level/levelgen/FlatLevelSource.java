...
public class FlatLevelSource extends ChunkGenerator {
   public static final Codec<FlatLevelSource> CODEC = RecordCodecBuilder.create((p_204551_) -> {
      return m_208005_(p_204551_).and(FlatLevelGeneratorSettings.CODEC.fieldOf("settings").forGetter(FlatLevelSource::settings)).apply(p_204551_, p_204551_.stable(FlatLevelSource::new));
   });
   private final FlatLevelGeneratorSettings settings;

   public FlatLevelSource(Registry<StructureSet> p_209099_, FlatLevelGeneratorSettings p_209100_) {
      super(p_209099_, p_209100_.m_209810_(), new FixedBiomeSource(p_209100_.m_204920_()), new FixedBiomeSource(p_209100_.m_204921_()), 0L);
   ...
   protected Holder<Biome> m_203427_(Holder<Biome> p_204553_) {
      return this.settings.m_204921_();
   }
   ...
   public void m_207076_(List<String> p_209102_, BlockPos p_209103_) {
   }
