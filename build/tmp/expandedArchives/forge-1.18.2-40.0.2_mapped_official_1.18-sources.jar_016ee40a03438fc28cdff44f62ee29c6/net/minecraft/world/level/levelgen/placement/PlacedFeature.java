...
public record PlacedFeature(Holder<ConfiguredFeature<?, ?>> feature, List<PlacementModifier> placement) {
   ...
   public static final Codec<HolderSet<PlacedFeature>> LIST_CODEC = RegistryCodecs.m_206279_(Registry.PLACED_FEATURE_REGISTRY, DIRECT_CODEC);
   public static final Codec<List<HolderSet<PlacedFeature>>> f_204922_ = RegistryCodecs.m_206287_(Registry.PLACED_FEATURE_REGISTRY, DIRECT_CODEC, true).listOf();
   ...
   private boolean placeWithContext(PlacementContext p_191798_, Random p_191799_, BlockPos p_191800_) {
      ...
      ConfiguredFeature<?, ?> configuredfeature = this.feature.m_203334_();
   ...
   public Stream<ConfiguredFeature<?, ?>> getFeatures() {
      return this.feature.m_203334_().getFeatures();
   }
   ...
   static record test(int f_204933_) {
   }
}