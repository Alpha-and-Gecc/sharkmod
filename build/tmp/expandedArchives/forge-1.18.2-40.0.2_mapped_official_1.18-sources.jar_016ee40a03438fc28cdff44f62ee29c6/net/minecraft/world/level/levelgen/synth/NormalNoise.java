...
public class NormalNoise {
   ...
   private final NormalNoise.NoiseParameters f_210625_;
   ...
   private NormalNoise(RandomSource p_210627_, NormalNoise.NoiseParameters p_210628_, boolean p_210629_) {
      ...
      this.f_210625_ = p_210628_;
      if (p_210629_) {
         this.first = PerlinNoise.create(p_210627_, i, doublelist);
         this.second = PerlinNoise.create(p_210627_, i, doublelist);
      } else {
         this.first = PerlinNoise.m_210645_(p_210627_, i, doublelist);
         this.second = PerlinNoise.m_210645_(p_210627_, i, doublelist);
      }
      ...
      this.f_210624_ = (this.first.m_210642_() + this.second.m_210642_()) * this.valueFactor;
   }
