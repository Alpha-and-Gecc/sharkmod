...
public class MineshaftFeature extends StructureFeature<MineshaftConfiguration> {
   ...
   private static boolean checkLocation(PieceGeneratorSupplier.Context<MineshaftConfiguration> p_197122_) {
      ...
      return worldgenrandom.nextDouble() >= d0 ? false : p_197122_.validBiome().test(p_197122_.chunkGenerator().m_203495_(QuartPos.fromBlock(p_197122_.chunkPos().getMiddleBlockX()), QuartPos.fromBlock(50), QuartPos.fromBlock(p_197122_.chunkPos().getMiddleBlockZ())));
   }
