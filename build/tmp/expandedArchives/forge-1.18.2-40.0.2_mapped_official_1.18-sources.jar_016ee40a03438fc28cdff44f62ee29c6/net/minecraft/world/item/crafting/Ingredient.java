...
public class Ingredient implements Predicate<ItemStack> {
   ...
   public static class TagValue implements Ingredient.Value {
      ...
      public Collection<ItemStack> getItems() {
         ...
         for(Holder<Item> holder : Registry.ITEM.m_206058_(this.tag)) {
            list.add(new ItemStack(holder));
         }

         if (list.size() == 0 && !net.minecraftforge.common.ForgeConfig.SERVER.treatEmptyTagsAsAir.get()) {
            list.add(new ItemStack(net.minecraft.world.level.block.Blocks.BARRIER).setHoverName(new net.minecraft.network.chat.TextComponent("Empty Tag: " + this.tag.f_203868_())));
         }
         return list;
      }
