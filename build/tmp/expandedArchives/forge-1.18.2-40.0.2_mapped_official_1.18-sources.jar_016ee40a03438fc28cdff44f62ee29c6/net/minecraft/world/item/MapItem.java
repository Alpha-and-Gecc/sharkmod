...
public class MapItem extends ComplexItem {
         ...
         if (p_42851_.dimension() == mapitemsaveddata.dimension) {
            ...
            for(int j1 = 0; j1 < 128; ++j1) {
               for(int k1 = 0; k1 < 128; ++k1) {
                  Biome.BiomeCategory biome$biomecategory = Biome.m_204183_(p_42851_.m_204166_(blockpos$mutableblockpos.set((l + k1) * i, 0, (i1 + j1) * i)));
               ...
               for(int k2 = 1; k2 < 127; ++k2) {
                  ...
                  for(int l1 = -1; l1 < 2; ++l1) {
                     for(int i2 = -1; i2 < 2; ++i2) {
                        if ((l1 != 0 || i2 != 0) && m_212251_(aboolean, j2 + l1, k2 + i2)) {
                           ++l2;
                        }
                     }
                  }
   ...
   public InteractionResult useOn(UseOnContext p_42885_) {
      ...
      if (blockstate.m_204336_(BlockTags.BANNERS)) {
