...
public class MoveThroughVillageGoal extends Goal {
   ...
   public boolean canContinueToUse() {
      if (this.mob.getNavigation().isDone()) {
         ...
         return !this.poiPos.m_203195_(this.mob.position(), (double)(this.mob.getBbWidth() + (float)this.distanceToPoi));
      }
   }
   ...
   public void stop() {
      if (this.mob.getNavigation().isDone() || this.poiPos.m_203195_(this.mob.position(), (double)this.distanceToPoi)) {
