...
public abstract class Raider extends PatrollingMonster {
   ...
   public class ObtainRaidLeaderBannerGoal<T extends Raider> extends Goal {
      ...
      public void tick() {
         if (this.mob.getNavigation().getTargetPos().m_203195_(this.mob.position(), 1.414D)) {
   ...
   static class RaiderMoveThroughVillageGoal extends Goal {
      ...
      public boolean canContinueToUse() {
         if (this.raider.getNavigation().isDone()) {
            ...
            return this.raider.getTarget() == null && !this.poiPos.m_203195_(this.raider.position(), (double)(this.raider.getBbWidth() + (float)this.distanceToPoi)) && !this.stuck;
         }
      }

      public void stop() {
         if (this.poiPos.m_203195_(this.raider.position(), (double)this.distanceToPoi)) {
