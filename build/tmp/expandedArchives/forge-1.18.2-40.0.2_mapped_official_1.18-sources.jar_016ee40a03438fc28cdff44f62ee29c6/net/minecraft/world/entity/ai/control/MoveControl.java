...
public class MoveControl implements Control {
   ...
   public void tick() {
      if (this.operation == MoveControl.Operation.STRAFE) {
         ...
         if (d2 > (double)this.mob.maxUpStep && d0 * d0 + d1 * d1 < (double)Math.max(1.0F, this.mob.getBbWidth()) || !voxelshape.isEmpty() && this.mob.getY() < voxelshape.max(Direction.Axis.Y) + (double)blockpos.getY() && !blockstate.m_204336_(BlockTags.DOORS) && !blockstate.m_204336_(BlockTags.FENCES)) {
