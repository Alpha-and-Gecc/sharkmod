...
public class SocializeAtBell extends Behavior<LivingEntity> {
   ...
   protected boolean checkExtraStartConditions(ServerLevel p_24170_, LivingEntity p_24171_) {
      ...
      return p_24170_.getRandom().nextInt(100) == 0 && optional.isPresent() && p_24170_.dimension() == optional.get().dimension() && optional.get().pos().m_203195_(p_24171_.position(), 4.0D) && brain.getMemory(MemoryModuleType.NEAREST_VISIBLE_LIVING_ENTITIES).get().contains((p_24189_) -> {
