...
public class Rabbit extends Animal {
   ...
   private int getRandomRabbitType(LevelAccessor p_29676_) {
      Holder<Biome> holder = p_29676_.m_204166_(this.blockPosition());
      int i = this.random.nextInt(100);
      if (holder.m_203334_().getPrecipitation() == Biome.Precipitation.SNOW) {
         return i < 80 ? 1 : 3;
      } else if (Biome.m_204183_(holder) == Biome.BiomeCategory.DESERT) {
         return 4;
      } else {
   ...
   public static boolean checkRabbitSpawnRules(EntityType<Rabbit> p_29699_, LevelAccessor p_29700_, MobSpawnType p_29701_, BlockPos p_29702_, Random p_29703_) {
      return p_29700_.getBlockState(p_29702_.below()).m_204336_(BlockTags.RABBITS_SPAWNABLE_ON) && isBrightEnoughToSpawn(p_29700_, p_29702_);
   }
