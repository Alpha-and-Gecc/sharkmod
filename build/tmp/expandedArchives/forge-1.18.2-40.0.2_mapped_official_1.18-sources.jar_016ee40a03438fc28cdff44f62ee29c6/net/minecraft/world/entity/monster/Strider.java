...
public class Strider extends Animal implements ItemSteerable, Saddleable {
   ...
   public static boolean checkStriderSpawnRules(EntityType<Strider> p_33922_, LevelAccessor p_33923_, MobSpawnType p_33924_, BlockPos p_33925_, Random p_33926_) {
      ...
      } while(p_33923_.getFluidState(blockpos$mutableblockpos).m_205070_(FluidTags.LAVA));
   ...
   public boolean m_203441_(FluidState p_204067_) {
      return p_204067_.m_205070_(FluidTags.LAVA);
   }
   ...
   public Vec3 getDismountLocationForPassenger(LivingEntity p_33908_) {
      ...
      for(BlockPos blockpos : set) {
         if (!this.level.getFluidState(blockpos).m_205070_(FluidTags.LAVA)) {
   ...
   public void tick() {
      ...
      boolean flag = blockstate.m_204336_(BlockTags.STRIDER_WARM_BLOCKS) || blockstate1.m_204336_(BlockTags.STRIDER_WARM_BLOCKS) || this.m_204036_(FluidTags.LAVA) > 0.0D;
   ...
   private void floatStrider() {
      if (this.isInLava()) {
         ...
         if (collisioncontext.isAbove(LiquidBlock.STABLE_SHAPE, this.blockPosition(), true) && !this.level.getFluidState(this.blockPosition().above()).m_205070_(FluidTags.LAVA)) {
            this.onGround = true;
         } else {
   ...
   protected boolean canAddPassenger(Entity p_33950_) {
      return !this.isVehicle() && !this.m_204029_(FluidTags.LAVA);
   }
   ...
   public float getWalkTargetValue(BlockPos p_33895_, LevelReader p_33896_) {
      if (p_33896_.getBlockState(p_33895_).getFluidState().m_205070_(FluidTags.LAVA)) {
         return 10.0F;
      } else {
