...
public class PiglinAi {
   ...
   protected static boolean wantsToPickup(Piglin p_34858_, ItemStack p_34859_) {
      if (p_34858_.isBaby() && p_34859_.m_204117_(ItemTags.IGNORED_BY_PIGLIN_BABIES)) {
         return false;
      } else if (p_34859_.m_204117_(ItemTags.PIGLIN_REPELLENTS)) {
         return false;
   ...
   protected static boolean isLovedItem(ItemStack p_149966_) {
      return p_149966_.m_204117_(ItemTags.PIGLIN_LOVED);
   }
   ...
   private static boolean isFood(ItemStack p_149970_) {
      return p_149970_.m_204117_(ItemTags.PIGLIN_FOOD);
   }
