...
public class DolphinJumpGoal extends JumpGoal {
   ...
   private boolean waterIsClear(BlockPos p_25173_, int p_25174_, int p_25175_, int p_25176_) {
      ...
      return this.dolphin.level.getFluidState(blockpos).m_205070_(FluidTags.WATER) && !this.dolphin.level.getBlockState(blockpos).getMaterial().blocksMotion();
   }
   ...
   public void tick() {
      ...
      if (!flag) {
         ...
         this.breached = fluidstate.m_205070_(FluidTags.WATER);
      }
