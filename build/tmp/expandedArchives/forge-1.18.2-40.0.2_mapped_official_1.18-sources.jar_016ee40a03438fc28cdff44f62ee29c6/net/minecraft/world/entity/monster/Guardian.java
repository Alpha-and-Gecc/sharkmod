...
public class Guardian extends Monster {
   ...
   public float getWalkTargetValue(BlockPos p_32831_, LevelReader p_32832_) {
      return p_32832_.getFluidState(p_32831_).m_205070_(FluidTags.WATER) ? 10.0F + p_32832_.getBrightness(p_32831_) - 0.5F : super.getWalkTargetValue(p_32831_, p_32832_);
   }
   ...
   public static boolean checkGuardianSpawnRules(EntityType<? extends Guardian> p_32837_, LevelAccessor p_32838_, MobSpawnType p_32839_, BlockPos p_32840_, Random p_32841_) {
      return (p_32841_.nextInt(20) == 0 || !p_32838_.canSeeSkyFromBelowWater(p_32840_)) && p_32838_.getDifficulty() != Difficulty.PEACEFUL && (p_32839_ == MobSpawnType.SPAWNER || p_32838_.getFluidState(p_32840_).m_205070_(FluidTags.WATER)) && p_32838_.getFluidState(p_32840_.below()).m_205070_(FluidTags.WATER);
   }
