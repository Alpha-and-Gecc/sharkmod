...
public class Dolphin extends WaterAnimal {
   ...
   protected InteractionResult mobInteract(Player p_28359_, InteractionHand p_28360_) {
      ...
      if (!itemstack.isEmpty() && itemstack.m_204117_(ItemTags.FISHES)) {
   ...
   protected boolean closeToNextPos() {
      ...
      return blockpos != null ? blockpos.m_203195_(this.position(), 12.0D) : false;
   }
   ...
   static class DolphinSwimToTreasureGoal extends Goal {
      ...
      public boolean canContinueToUse() {
         ...
         return !(new BlockPos((double)blockpos.getX(), this.dolphin.getY(), (double)blockpos.getZ())).m_203195_(this.dolphin.position(), 4.0D) && !this.stuck && this.dolphin.getAirSupply() >= 100;
      }
      ...
      public void start() {
         if (this.dolphin.level instanceof ServerLevel) {
            ...
            BlockPos blockpos1 = serverlevel.m_207561_(ConfiguredStructureTags.f_207633_, blockpos, 50, false);
            if (blockpos1 != null) {
      ...
      public void stop() {
         BlockPos blockpos = this.dolphin.getTreasurePos();
         if ((new BlockPos((double)blockpos.getX(), this.dolphin.getY(), (double)blockpos.getZ())).m_203195_(this.dolphin.position(), 4.0D) || this.stuck) {
      ...
      public void tick() {
         ...
         if (this.dolphin.closeToNextPos() || this.dolphin.getNavigation().isDone()) {
            ...
            if (vec31 != null) {
               ...
               if (!level.getFluidState(blockpos).m_205070_(FluidTags.WATER) || !level.getBlockState(blockpos).isPathfindable(level, blockpos, PathComputationType.WATER)) {
