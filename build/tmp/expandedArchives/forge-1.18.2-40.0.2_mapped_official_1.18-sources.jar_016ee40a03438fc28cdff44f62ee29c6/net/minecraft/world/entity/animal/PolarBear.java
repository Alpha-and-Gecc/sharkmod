...
public class PolarBear extends Animal implements NeutralMob {
   ...
   public static boolean checkPolarBearSpawnRules(EntityType<PolarBear> p_29550_, LevelAccessor p_29551_, MobSpawnType p_29552_, BlockPos p_29553_, Random p_29554_) {
      Holder<Biome> holder = p_29551_.m_204166_(p_29553_);
      if (!holder.m_203565_(Biomes.FROZEN_OCEAN) && !holder.m_203565_(Biomes.DEEP_FROZEN_OCEAN)) {
         ...
         return isBrightEnoughToSpawn(p_29551_, p_29553_) && p_29551_.getBlockState(p_29553_.below()).m_204336_(BlockTags.POLAR_BEARS_SPAWNABLE_ON_IN_FROZEN_OCEAN);
      }
   }
