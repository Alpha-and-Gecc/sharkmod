...
public class DismountHelper {
   ...
   public static VoxelShape nonClimbableShape(BlockGetter p_38447_, BlockPos p_38448_) {
      ...
      return !blockstate.m_204336_(BlockTags.CLIMBABLE) && (!(blockstate.getBlock() instanceof TrapDoorBlock) || !blockstate.getValue(TrapDoorBlock.OPEN)) ? blockstate.getCollisionShape(p_38447_, p_38448_) : Shapes.empty();
   }
