...
public class Drowned extends Zombie implements RangedAttackMob {
   ...
   public static boolean checkDrownedSpawnRules(EntityType<Drowned> p_32350_, ServerLevelAccessor p_32351_, MobSpawnType p_32352_, BlockPos p_32353_, Random p_32354_) {
      if (!p_32351_.getFluidState(p_32353_.below()).m_205070_(FluidTags.WATER)) {
         return false;
      } else {
         Holder<Biome> holder = p_32351_.m_204166_(p_32353_);
         boolean flag = p_32351_.getDifficulty() != Difficulty.PEACEFUL && isDarkEnoughToSpawn(p_32351_, p_32353_, p_32354_) && (p_32352_ == MobSpawnType.SPAWNER || p_32351_.getFluidState(p_32353_).m_205070_(FluidTags.WATER));
         if (!holder.m_203565_(Biomes.RIVER) && !holder.m_203565_(Biomes.FROZEN_RIVER)) {
