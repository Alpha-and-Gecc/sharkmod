...
public class GoalUtils {
   ...
   public static boolean mobRestricted(PathfinderMob p_148443_, int p_148444_) {
      return p_148443_.hasRestriction() && p_148443_.getRestrictCenter().m_203195_(p_148443_.position(), (double)(p_148443_.getRestrictRadius() + (float)p_148444_) + 1.0D);
   }
   ...
   public static boolean isWater(PathfinderMob p_148446_, BlockPos p_148447_) {
      return p_148446_.level.getFluidState(p_148447_).m_205070_(FluidTags.WATER);
   }
