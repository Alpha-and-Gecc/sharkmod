...
public class ItemEntity extends Entity {
   ...
   public boolean occludesVibrations() {
      return this.getItem().m_204117_(ItemTags.OCCLUDES_VIBRATION_SIGNALS);
   }
   ...
   public void tick() {
      ...
      if (this.getItem().isEmpty()) {
         ...
         if (this.isInWater() && this.m_204036_(FluidTags.WATER) > (double)f) {
            this.setUnderwaterMovement();
         } else if (this.isInLava() && this.m_204036_(FluidTags.LAVA) > (double)f) {
