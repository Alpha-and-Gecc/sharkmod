...
public class AxolotlAttackablesSensor extends NearestVisibleLivingEntitySensor {
   ...
   private boolean isHuntTarget(LivingEntity p_148272_, LivingEntity p_148273_) {
      return !p_148272_.getBrain().hasMemoryValue(MemoryModuleType.HAS_HUNTING_COOLDOWN) && p_148273_.getType().m_204039_(EntityTypeTags.AXOLOTL_HUNT_TARGETS);
   }

   private boolean isHostileTarget(LivingEntity p_148270_) {
      return p_148270_.getType().m_204039_(EntityTypeTags.AXOLOTL_ALWAYS_HOSTILES);
   }
