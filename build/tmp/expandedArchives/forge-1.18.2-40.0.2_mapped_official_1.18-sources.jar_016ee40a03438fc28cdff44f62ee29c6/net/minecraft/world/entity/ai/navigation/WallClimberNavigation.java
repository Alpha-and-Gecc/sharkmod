   ...
   public void tick() {
      if (!this.isDone()) {
         ...
         if (this.pathToPosition != null) {
            // FORGE: Fix MC-94054
            if (!this.pathToPosition.m_203195_(this.mob.position(), Math.max((double)this.mob.getBbWidth(), 1.0D)) && (!(this.mob.getY() > (double)this.pathToPosition.getY()) || !(new BlockPos((double)this.pathToPosition.getX(), this.mob.getY(), (double)this.pathToPosition.getZ())).m_203195_(this.mob.position(), Math.max((double)this.mob.getBbWidth(), 1.0D)))) {
