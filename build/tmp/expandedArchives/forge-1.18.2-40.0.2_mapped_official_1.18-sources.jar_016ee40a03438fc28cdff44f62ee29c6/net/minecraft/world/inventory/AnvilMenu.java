...
public class AnvilMenu extends ItemCombinerMenu {
   ...
   protected boolean isValidBlock(BlockState p_39019_) {
      return p_39019_.m_204336_(BlockTags.ANVIL);
   }
   ...
   protected void onTake(Player p_150474_, ItemStack p_150475_) {
      ...
      this.access.execute((p_150479_, p_150480_) -> {
         ...
         if (!p_150474_.getAbilities().instabuild && blockstate.m_204336_(BlockTags.ANVIL) && p_150474_.getRandom().nextFloat() < breakChance) {
