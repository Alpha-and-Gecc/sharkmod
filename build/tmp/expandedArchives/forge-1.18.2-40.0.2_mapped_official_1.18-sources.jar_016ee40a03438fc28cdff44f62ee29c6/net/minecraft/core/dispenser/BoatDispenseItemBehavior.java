...
public class BoatDispenseItemBehavior extends DefaultDispenseItemBehavior {
   ...
   public ItemStack execute(BlockSource p_123375_, ItemStack p_123376_) {
      ...
      double d3;
      if (level.getFluidState(blockpos).m_205070_(FluidTags.WATER)) {
         d3 = 1.0D;
      } else {
         if (!level.getBlockState(blockpos).isAir() || !level.getFluidState(blockpos.below()).m_205070_(FluidTags.WATER)) {
