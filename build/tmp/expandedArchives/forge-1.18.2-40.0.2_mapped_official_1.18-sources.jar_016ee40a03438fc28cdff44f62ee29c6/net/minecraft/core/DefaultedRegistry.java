...
public class DefaultedRegistry<T> extends MappedRegistry<T> {
   ...
   public Holder<T> m_203704_(int p_205698_, ResourceKey<T> p_205699_, T p_205700_, Lifecycle p_205701_) {
      Holder<T> holder = super.m_203704_(p_205698_, p_205699_, p_205700_, p_205701_);
   ...
   public int getId(@Nullable T p_122324_) {
      ...
      return i == -1 ? super.getId(this.defaultValue.m_203334_()) : i;
   }
   ...
   public T get(@Nullable ResourceLocation p_122328_) {
      ...
      return (T)(t == null ? this.defaultValue.m_203334_() : t);
   }
   ...
   public Optional<Holder<T>> m_203454_(Random p_205703_) {
      return super.m_203454_(p_205703_).or(() -> {
