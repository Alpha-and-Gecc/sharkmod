...
public class Vec3i implements Comparable<Vec3i> {
   ...
   public boolean m_203195_(Position p_203196_, double p_203197_) {
      return this.m_203193_(p_203196_) < Mth.square(p_203197_);
   }

   public double distSqr(Vec3i p_123332_) {
      return this.m_203202_((double)p_123332_.getX(), (double)p_123332_.getY(), (double)p_123332_.getZ());
   }

   public double m_203193_(Position p_203194_) {
      return this.m_203198_(p_203194_.x(), p_203194_.y(), p_203194_.z());
   }
