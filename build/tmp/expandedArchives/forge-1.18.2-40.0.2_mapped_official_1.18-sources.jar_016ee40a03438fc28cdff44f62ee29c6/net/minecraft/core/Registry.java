...
public abstract class Registry<T> implements Keyable, IdMap<T> {
   ...
   public static final DefaultedRegistry<GameEvent> GAME_EVENT = m_206031_(GAME_EVENT_REGISTRY, "step", GameEvent::m_204530_, (p_206044_) -> {
   ...
   public static final Registry<ResourceLocation> CUSTOM_STAT = m_206008_(CUSTOM_STAT_REGISTRY, (p_205964_) -> {
      return Stats.JUMP;
   });
   @Deprecated public static final DefaultedRegistry<ChunkStatus> CHUNK_STATUS = forge(CHUNK_STATUS_REGISTRY, "empty", (registry) -> {
      return ChunkStatus.EMPTY;
   });
   public static final Registry<RuleTestType<?>> RULE_TEST = m_206008_(RULE_TEST_REGISTRY, (p_205960_) -> {
      return RuleTestType.ALWAYS_TRUE_TEST;
   });
   public static final Registry<PosRuleTestType<?>> POS_RULE_TEST = m_206008_(POS_RULE_TEST_REGISTRY, (p_205958_) -> {
      return PosRuleTestType.ALWAYS_TRUE_TEST;
   });
   @Deprecated public static final Registry<MenuType<?>> MENU = forge(MENU_REGISTRY, (registry) -> {
      return MenuType.ANVIL;
   });
   public static final Registry<RecipeType<?>> RECIPE_TYPE = m_206008_(RECIPE_TYPE_REGISTRY, (p_205954_) -> {
   ...
   public static final Registry<PositionSourceType<?>> POSITION_SOURCE_TYPE = m_206008_(POSITION_SOURCE_TYPE_REGISTRY, (p_205948_) -> {
      return PositionSourceType.BLOCK;
   });
   @Deprecated public static final Registry<StatType<?>> STAT_TYPE = forge(STAT_TYPE_REGISTRY, (registry) -> {
      return Stats.ITEM_USED;
   });
   public static final DefaultedRegistry<VillagerType> VILLAGER_TYPE = m_206027_(VILLAGER_TYPE_REGISTRY, "plains", (p_205944_) -> {
   ...
   public static final Registry<LootPoolEntryType> LOOT_POOL_ENTRY_TYPE = m_206008_(LOOT_ENTRY_REGISTRY, (p_206133_) -> {
      return LootPoolEntries.EMPTY;
   });
   public static final Registry<LootItemFunctionType> LOOT_FUNCTION_TYPE = m_206008_(LOOT_FUNCTION_REGISTRY, (p_206131_) -> {
      return LootItemFunctions.SET_COUNT;
   });
   public static final Registry<LootItemConditionType> LOOT_CONDITION_TYPE = m_206008_(LOOT_ITEM_REGISTRY, (p_206129_) -> {
      return LootItemConditions.INVERTED;
   });
   public static final Registry<LootNumberProviderType> LOOT_NUMBER_PROVIDER_TYPE = m_206008_(LOOT_NUMBER_PROVIDER_REGISTRY, (p_206127_) -> {
      return NumberProviders.CONSTANT;
   });
   public static final Registry<LootNbtProviderType> LOOT_NBT_PROVIDER_TYPE = m_206008_(LOOT_NBT_PROVIDER_REGISTRY, (p_206125_) -> {
      return NbtProviders.CONTEXT;
   });
   public static final Registry<LootScoreProviderType> LOOT_SCORE_PROVIDER_TYPE = m_206008_(LOOT_SCORE_PROVIDER_REGISTRY, (p_206123_) -> {
   ...
   public static final Registry<FloatProviderType<?>> FLOAT_PROVIDER_TYPES = m_206008_(FLOAT_PROVIDER_TYPE_REGISTRY, (p_206121_) -> {
   ...
   public static final Registry<IntProviderType<?>> INT_PROVIDER_TYPES = m_206008_(INT_PROVIDER_TYPE_REGISTRY, (p_206119_) -> {
   ...
   public static final Registry<HeightProviderType<?>> HEIGHT_PROVIDER_TYPES = m_206008_(HEIGHT_PROVIDER_TYPE_REGISTRY, (p_206117_) -> {
   ...
   public static final Registry<BlockPredicateType<?>> BLOCK_PREDICATE_TYPES = m_206008_(BLOCK_PREDICATE_TYPE_REGISTRY, (p_206114_) -> {
   ...
   public static final ResourceKey<Registry<StructureSet>> f_211073_ = createRegistryKey("worldgen/structure_set");
   ...
   public static final ResourceKey<Registry<DensityFunction>> f_211074_ = createRegistryKey("worldgen/density_function");
   ...
   public static final ResourceKey<Registry<StructurePlacementType<?>>> f_205929_ = createRegistryKey("worldgen/structure_placement");
   public static final Registry<StructurePlacementType<?>> f_205930_ = m_206008_(f_205929_, (p_206105_) -> {
   ...
   public static final Registry<StructurePieceType> STRUCTURE_PIECE = m_206008_(STRUCTURE_PIECE_REGISTRY, (p_211080_) -> {
   ...
   public static final Registry<PlacementModifierType<?>> PLACEMENT_MODIFIERS = m_206008_(PLACEMENT_MODIFIER_REGISTRY, (p_206100_) -> {
   ...
   public static final ResourceKey<Registry<Codec<? extends DensityFunction>>> f_211075_ = createRegistryKey("worldgen/density_function_type");
   ...
   public static final Registry<TrunkPlacerType<?>> TRUNK_PLACER_TYPES = m_206008_(TRUNK_PLACER_TYPE_REGISTRY, (p_206086_) -> {
   ...
   public static final Registry<FeatureSizeType<?>> FEATURE_SIZE_TYPES = m_206008_(FEATURE_SIZE_TYPE_REGISTRY, (p_206072_) -> {
      return FeatureSizeType.TWO_LAYERS_FEATURE_SIZE;
   });
   public static final Registry<Codec<? extends BiomeSource>> BIOME_SOURCE = m_205999_(BIOME_SOURCE_REGISTRY, Lifecycle.stable(), (p_206067_) -> {
      return BiomeSource.CODEC;
   });
   public static final Registry<Codec<? extends ChunkGenerator>> CHUNK_GENERATOR = m_205999_(CHUNK_GENERATOR_REGISTRY, Lifecycle.stable(), (p_206063_) -> {
      return ChunkGenerator.CODEC;
   });
   public static final Registry<Codec<? extends SurfaceRules.ConditionSource>> CONDITION = m_206008_(CONDITION_REGISTRY, (RegistryBootstrap)SurfaceRules.ConditionSource::m_204624_);
   public static final Registry<Codec<? extends SurfaceRules.RuleSource>> RULE = m_206008_(RULE_REGISTRY, (RegistryBootstrap)SurfaceRules.RuleSource::m_204630_);
   ...
   public static final Registry<StructureProcessorType<?>> STRUCTURE_PROCESSOR = m_206008_(STRUCTURE_PROCESSOR_REGISTRY, (p_206056_) -> {
      return StructureProcessorType.BLOCK_IGNORE;
   });
   public static final Registry<StructurePoolElementType<?>> STRUCTURE_POOL_ELEMENT = m_206008_(STRUCTURE_POOL_ELEMENT_REGISTRY, (p_211078_) -> {
   ...
   private static <T> Registry<T> m_206008_(ResourceKey<? extends Registry<T>> p_206009_, Registry.RegistryBootstrap<T> p_206010_) {
   ...
   private static <T> Registry<T> m_206003_(ResourceKey<? extends Registry<T>> p_206004_, Lifecycle p_206005_, Function<T, Holder.Reference<T>> p_206006_, Registry.RegistryBootstrap<T> p_206007_) {
      return m_206011_(p_206004_, new MappedRegistry<>(p_206004_, p_206005_, p_206006_), p_206007_, p_206005_);
   }

   private static <T> DefaultedRegistry<T> m_206016_(ResourceKey<? extends Registry<T>> p_206017_, String p_206018_, Lifecycle p_206019_, Registry.RegistryBootstrap<T> p_206020_) {
      return m_206011_(p_206017_, new DefaultedRegistry<>(p_206018_, p_206017_, p_206019_, (Function<T, Holder.Reference<T>>)null), p_206020_, p_206019_);
   }

   private static <T> DefaultedRegistry<T> m_206021_(ResourceKey<? extends Registry<T>> p_206022_, String p_206023_, Lifecycle p_206024_, Function<T, Holder.Reference<T>> p_206025_, Registry.RegistryBootstrap<T> p_206026_) {
      return m_206011_(p_206022_, new DefaultedRegistry<>(p_206023_, p_206022_, p_206024_, p_206025_), p_206026_, p_206024_);
   }

   private static <T, R extends WritableRegistry<T>> R m_206011_(ResourceKey<? extends Registry<T>> p_206012_, R p_206013_, Registry.RegistryBootstrap<T> p_206014_, Lifecycle p_206015_) {
      ResourceLocation resourcelocation = p_206012_.location();
      LOADERS.put(resourcelocation, () -> {
         return p_206014_.m_206149_(p_206013_);
      });
      WRITABLE_REGISTRY.m_203505_((ResourceKey)p_206012_, p_206013_, p_206015_);
      return p_206013_;
   }
   ...
   public Codec<Holder<T>> m_206110_() {
      Codec<Holder<T>> codec = ResourceLocation.CODEC.flatXmap((p_206065_) -> {
         return this.m_203636_(ResourceKey.create(this.key, p_206065_)).map(DataResult::success).orElseGet(() -> {
            return DataResult.error("Unknown registry key in " + this.key + ": " + p_206065_);
         });
      }, (p_206054_) -> {
         return p_206054_.m_203543_().map(ResourceKey::location).map(DataResult::success).orElseGet(() -> {
      ...
      return ExtraCodecs.overrideLifecycle(codec, (p_206047_) -> {
         return this.lifecycle(p_206047_.m_203334_());
      }, (p_205988_) -> {
         return this.lifecycle;
      });
   }
   ...
   public abstract Optional<Holder<T>> m_203454_(Random p_205998_);
   ...
   public static <V, T extends V> T register(Registry<V> p_194580_, ResourceKey<V> p_194581_, T p_194582_) {
      ((WritableRegistry)p_194580_).m_203505_(p_194581_, (V)p_194582_, Lifecycle.stable());
      return p_194582_;
   }

   public static <V, T extends V> T registerMapping(Registry<V> p_122957_, int p_122958_, String p_122959_, T p_122960_) {
      ((WritableRegistry)p_122957_).m_203704_(p_122958_, ResourceKey.create(p_122957_.key, new ResourceLocation(p_122959_)), (V)p_122960_, Lifecycle.stable());
      return p_122960_;
   }

   public abstract Registry<T> m_203521_();

   public abstract Holder<T> m_203538_(ResourceKey<T> p_206057_);

   public abstract Holder.Reference<T> m_203693_(T p_206068_);

   public abstract Optional<Holder<T>> m_203300_(int p_206051_);

   public abstract Optional<Holder<T>> m_203636_(ResourceKey<T> p_206050_);

   public Holder<T> m_206081_(ResourceKey<T> p_206082_) {
      return this.m_203636_(p_206082_).orElseThrow(() -> {
   ...
   public abstract boolean m_203658_(TagKey<T> p_205983_);

   public abstract void m_203635_();

   public abstract void m_203652_(Map<TagKey<T>, List<Holder<T>>> p_205997_);

   public IdMap<Holder<T>> m_206115_() {
      return new IdMap<Holder<T>>() {
         public int getId(Holder<T> p_206142_) {
            return Registry.this.getId(p_206142_.m_203334_());
         }
   ...
   static {
      ...
      m_205992_(WRITABLE_REGISTRY);
   }

   @FunctionalInterface
   interface RegistryBootstrap<T> {
      T m_206149_(Registry<T> p_206150_);
   }
}
