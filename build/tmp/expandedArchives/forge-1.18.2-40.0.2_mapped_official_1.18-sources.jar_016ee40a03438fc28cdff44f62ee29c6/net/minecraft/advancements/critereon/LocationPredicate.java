...
public class LocationPredicate {
   ...
   public static LocationPredicate m_207928_(ResourceKey<ConfiguredStructureFeature<?, ?>> p_207929_) {
   ...
   public boolean matches(ServerLevel p_52618_, double p_52619_, double p_52620_, double p_52621_) {
      if (!this.x.matches(p_52619_)) {
         ...
         if (this.biome == null || flag && p_52618_.m_204166_(blockpos).m_203565_(this.biome)) {
            if (this.feature == null || flag && p_52618_.structureFeatureManager().m_207791_(blockpos, this.feature).isValid()) {
   ...
   public static class Builder {
      ...
      public LocationPredicate.Builder m_207930_(@Nullable ResourceKey<ConfiguredStructureFeature<?, ?>> p_207931_) {
