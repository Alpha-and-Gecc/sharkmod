...
public class ItemPredicate {
   ...
   public boolean matches(ItemStack p_45050_) {
      if (this == ANY) {
         return true;
      } else if (this.tag != null && !p_45050_.m_204117_(this.tag)) {
         return false;
      ...
      if (p_45052_ != null && !p_45052_.isJsonNull()) {
         ...
         if (jsonobject.has("data")) {
            ...
            if (jsonobject.has("tag")) {
               ...
               tagkey = TagKey.m_203882_(Registry.ITEM_REGISTRY, resourcelocation1);
            }
   ...
   public static class Builder {
      ...
      public ItemPredicate.Builder m_204145_(TagKey<Item> p_204146_) {
         this.tag = p_204146_;
         return this;
      }
