...
public class FluidPredicate {
   ...
   public boolean matches(ServerLevel p_41105_, BlockPos p_41106_) {
      if (this == ANY) {
         ...
         if (this.tag != null && !fluidstate.m_205070_(this.tag)) {
            return false;
   ...
   public static FluidPredicate fromJson(@Nullable JsonElement p_41108_) {
      if (p_41108_ != null && !p_41108_.isJsonNull()) {
         ...
         if (jsonobject.has("tag")) {
            ...
            tagkey = TagKey.m_203882_(Registry.FLUID_REGISTRY, resourcelocation1);
         }
   ...
   public static class Builder {
      ...
      public FluidPredicate.Builder m_204105_(TagKey<Fluid> p_204106_) {
