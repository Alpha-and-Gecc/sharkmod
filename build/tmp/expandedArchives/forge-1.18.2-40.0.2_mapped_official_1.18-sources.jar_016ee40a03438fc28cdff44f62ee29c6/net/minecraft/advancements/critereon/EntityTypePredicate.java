...
public abstract class EntityTypePredicate {
   ...
   public static EntityTypePredicate fromJson(@Nullable JsonElement p_37644_) {
      if (p_37644_ != null && !p_37644_.isJsonNull()) {
         ...
         if (s.startsWith("#")) {
            ...
            return new EntityTypePredicate.TagPredicate(TagKey.m_203882_(Registry.ENTITY_TYPE_REGISTRY, resourcelocation1));
         } else {
   ...
   static class TagPredicate extends EntityTypePredicate {
      ...
      public boolean matches(EntityType<?> p_37658_) {
         return p_37658_.m_204039_(this.tag);
      }

      public JsonElement serializeToJson() {
         return new JsonPrimitive("#" + this.tag.f_203868_());
      }
   }
