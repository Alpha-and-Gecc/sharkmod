...
public class ExtraCodecs {
   ...
   public static <T> Function<HolderSet<T>, DataResult<HolderSet<T>>> m_203981_() {
      return (p_203975_) -> {
         return p_203975_.m_203440_().right().filter(List::isEmpty).isPresent() ? DataResult.error("List must have contents") : DataResult.success(p_203975_);
      };
   }

   public static <T> Codec<HolderSet<T>> m_203982_(Codec<HolderSet<T>> p_203983_) {
      return p_203983_.flatXmap(m_203981_(), m_203981_());
   }
   ...
   public static <E> MapCodec<E> m_203976_(final Function<DynamicOps<?>, DataResult<E>> p_203977_) {
