...
public class ClientChunkCache extends ChunkSource {
   ...
   public ClientChunkCache(ClientLevel p_104414_, int p_104415_) {
      ...
      this.emptyChunk = new EmptyLevelChunk(p_104414_, new ChunkPos(0, 0), p_104414_.registryAccess().registryOrThrow(Registry.BIOME_REGISTRY).m_206081_(Biomes.PLAINS));
