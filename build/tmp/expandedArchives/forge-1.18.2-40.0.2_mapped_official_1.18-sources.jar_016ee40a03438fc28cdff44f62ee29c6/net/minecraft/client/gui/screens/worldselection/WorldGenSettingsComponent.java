...
public class WorldGenSettingsComponent implements Widget {
   ...
   public void init(CreateWorldScreen p_101430_, Minecraft p_101431_, Font p_101432_) {
      ...
      this.seedEdit.setResponder((p_101465_) -> {
         this.seed = WorldGenSettings.m_202192_(this.seedEdit.getValue());
      });
      ...
      this.typeButton = p_101430_.addRenderableWidget(CycleButton.builder(WorldPreset::description).withValues(WorldPreset.PRESETS.stream().filter(WorldPreset::isVisibleByDefault).collect(Collectors.toList()), WorldPreset.PRESETS).withCustomNarration((p_170264_) -> {
         ...
         this.settings = p_170275_.m_205485_(this.registryHolder, this.settings.seed(), this.settings.generateFeatures(), this.settings.generateBonusChest());
         ...
         if (s != null) {
            ...
            label74: {
               ...
               try {
                  ...
                  label70: {
                     try {
                        DynamicOps<JsonElement> dynamicops = RegistryOps.m_206813_(JsonOps.INSTANCE, registryaccess$writable, closeableresourcemanager);
               ...
               dataresult.resultOrPartial(LOGGER::error).ifPresent((p_205461_) -> {
                  BooleanConsumer booleanconsumer = (p_205467_) -> {
                     ...
                     if (p_205467_) {
                        this.m_205468_(registryaccess$writable.m_203557_(), p_205461_);
                     }
   ...
   public WorldGenSettings makeSettings(boolean p_101455_) {
      OptionalLong optionallong = WorldGenSettings.m_202192_(this.seedEdit.getValue());
   ...
   void m_205471_(WorldStem p_205472_) {
      this.settings = p_205472_.f_206895_().worldGenSettings();
      this.registryHolder = p_205472_.f_206894_();
   }
