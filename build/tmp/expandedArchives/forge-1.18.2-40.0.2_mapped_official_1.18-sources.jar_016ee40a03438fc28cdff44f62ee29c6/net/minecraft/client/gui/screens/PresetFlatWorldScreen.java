...
public class PresetFlatWorldScreen extends Screen {
   ...
   public static FlatLevelGeneratorSettings m_211771_(Registry<Biome> p_211772_, Registry<StructureSet> p_211773_, String p_211774_, FlatLevelGeneratorSettings p_211775_) {
      ...
      if (!iterator.hasNext()) {
         ...
         if (list.isEmpty()) {
            ...
            FlatLevelGeneratorSettings flatlevelgeneratorsettings = p_211775_.m_209803_(list, p_211775_.m_209810_());
            ...
            flatlevelgeneratorsettings.m_204918_(p_211772_.m_203538_(resourcekey));
   ...
   static String m_205393_(FlatLevelGeneratorSettings p_205394_) {
      ...
      stringbuilder.append(";");
      stringbuilder.append(p_205394_.m_204921_().m_203543_().map(ResourceKey::location).orElseThrow(() -> {
   ...
   protected void init() {
      ...
      RegistryAccess registryaccess = this.parent.parent.worldGenSettingsComponent.m_205473_();
      Registry<Biome> registry = registryaccess.registryOrThrow(Registry.BIOME_REGISTRY);
      Registry<StructureSet> registry1 = registryaccess.registryOrThrow(Registry.f_211073_);
      this.export.setValue(m_205393_(this.parent.settings()));
      ...
      this.selectButton = this.addRenderableWidget(new Button(this.width / 2 - 155, this.height - 28, 150, 20, new TranslatableComponent("createWorld.customize.presets.select"), (p_211770_) -> {
         FlatLevelGeneratorSettings flatlevelgeneratorsettings = m_211771_(registry, registry1, this.export.getValue(), this.settings);
   ...
   private static void m_210849_(Component p_210850_, ItemLike p_210851_, ResourceKey<Biome> p_210852_, Set<ResourceKey<StructureSet>> p_210853_, boolean p_210854_, boolean p_210855_, FlatLayerInfo... p_210856_) {
      PRESETS.add(new PresetFlatWorldScreen.PresetInfo(p_210851_.asItem(), p_210850_, (p_210848_) -> {
         ...
         Registry<StructureSet> registry1 = p_210848_.registryOrThrow(Registry.f_211073_);
         HolderSet.Direct<StructureSet> direct = HolderSet.m_205800_(p_210853_.stream().flatMap((p_210841_) -> {
            return registry1.m_203636_(p_210841_).stream();
         ...
         flatlevelgeneratorsettings.m_204918_(registry.m_203538_(p_210852_));
   ...
   static {
      m_210849_(new TranslatableComponent("createWorld.customize.preset.classic_flat"), Blocks.GRASS_BLOCK, Biomes.PLAINS, Set.of(BuiltinStructureSets.f_209820_), false, false, new FlatLayerInfo(1, Blocks.GRASS_BLOCK), new FlatLayerInfo(2, Blocks.DIRT), new FlatLayerInfo(1, Blocks.BEDROCK));
      m_210849_(new TranslatableComponent("createWorld.customize.preset.tunnelers_dream"), Blocks.STONE, Biomes.WINDSWEPT_HILLS, Set.of(BuiltinStructureSets.f_209829_, BuiltinStructureSets.f_209836_), true, false, new FlatLayerInfo(1, Blocks.GRASS_BLOCK), new FlatLayerInfo(5, Blocks.DIRT), new FlatLayerInfo(230, Blocks.STONE), new FlatLayerInfo(1, Blocks.BEDROCK));
      m_210849_(new TranslatableComponent("createWorld.customize.preset.water_world"), Items.WATER_BUCKET, Biomes.DEEP_OCEAN, Set.of(BuiltinStructureSets.f_209832_, BuiltinStructureSets.f_209831_, BuiltinStructureSets.f_209826_), false, false, new FlatLayerInfo(90, Blocks.WATER), new FlatLayerInfo(5, Blocks.GRAVEL), new FlatLayerInfo(5, Blocks.DIRT), new FlatLayerInfo(5, Blocks.STONE), new FlatLayerInfo(64, Blocks.DEEPSLATE), new FlatLayerInfo(1, Blocks.BEDROCK));
      m_210849_(new TranslatableComponent("createWorld.customize.preset.overworld"), Blocks.GRASS, Biomes.PLAINS, Set.of(BuiltinStructureSets.f_209820_, BuiltinStructureSets.f_209829_, BuiltinStructureSets.f_209825_, BuiltinStructureSets.f_209830_, BuiltinStructureSets.f_209836_), true, true, new FlatLayerInfo(1, Blocks.GRASS_BLOCK), new FlatLayerInfo(3, Blocks.DIRT), new FlatLayerInfo(59, Blocks.STONE), new FlatLayerInfo(1, Blocks.BEDROCK));
      m_210849_(new TranslatableComponent("createWorld.customize.preset.snowy_kingdom"), Blocks.SNOW, Biomes.SNOWY_PLAINS, Set.of(BuiltinStructureSets.f_209820_, BuiltinStructureSets.f_209822_), false, false, new FlatLayerInfo(1, Blocks.SNOW), new FlatLayerInfo(1, Blocks.GRASS_BLOCK), new FlatLayerInfo(3, Blocks.DIRT), new FlatLayerInfo(59, Blocks.STONE), new FlatLayerInfo(1, Blocks.BEDROCK));
      m_210849_(new TranslatableComponent("createWorld.customize.preset.bottomless_pit"), Items.FEATHER, Biomes.PLAINS, Set.of(BuiltinStructureSets.f_209820_), false, false, new FlatLayerInfo(1, Blocks.GRASS_BLOCK), new FlatLayerInfo(3, Blocks.DIRT), new FlatLayerInfo(2, Blocks.COBBLESTONE));
      m_210849_(new TranslatableComponent("createWorld.customize.preset.desert"), Blocks.SAND, Biomes.DESERT, Set.of(BuiltinStructureSets.f_209820_, BuiltinStructureSets.f_209821_, BuiltinStructureSets.f_209829_, BuiltinStructureSets.f_209836_), true, false, new FlatLayerInfo(8, Blocks.SAND), new FlatLayerInfo(52, Blocks.SANDSTONE), new FlatLayerInfo(3, Blocks.STONE), new FlatLayerInfo(1, Blocks.BEDROCK));
      m_210849_(new TranslatableComponent("createWorld.customize.preset.redstone_ready"), Items.REDSTONE, Biomes.DESERT, Set.of(), false, false, new FlatLayerInfo(116, Blocks.SANDSTONE), new FlatLayerInfo(3, Blocks.STONE), new FlatLayerInfo(1, Blocks.BEDROCK));
      m_210849_(new TranslatableComponent("createWorld.customize.preset.the_void"), Blocks.BARRIER, Biomes.THE_VOID, Set.of(), true, false, new FlatLayerInfo(1, Blocks.AIR));
   }
   ...
   class PresetsList extends ObjectSelectionList<PresetFlatWorldScreen.PresetsList.Entry> {
      ...
      public class Entry extends ObjectSelectionList.Entry<PresetFlatWorldScreen.PresetsList.Entry> {
         ...
         void select() {
            ...
            PresetFlatWorldScreen.this.settings = this.preset.settings.apply(PresetFlatWorldScreen.this.parent.parent.worldGenSettingsComponent.m_205473_());
            PresetFlatWorldScreen.this.export.setValue(PresetFlatWorldScreen.m_205393_(PresetFlatWorldScreen.this.settings));
