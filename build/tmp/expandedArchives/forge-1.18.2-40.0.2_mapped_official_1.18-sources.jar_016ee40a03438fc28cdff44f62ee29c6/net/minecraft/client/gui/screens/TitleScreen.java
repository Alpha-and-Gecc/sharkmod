...
public class TitleScreen extends Screen {
   ...
   public TitleScreen(boolean p_96733_) {
      ...
      this.f_210858_ = RealmsClient.create();
   }
   ...
   private void m_210873_() {
      try {
         if (this.f_210857_ != null && !this.minecraft.options.f_210816_ && !this.f_210859_ && this.f_210857_.f_210878_.getNow(false)) {
            this.f_210859_ = true;
   ...
   protected void init() {
      ...
      if (!this.minecraft.is64Bit()) {
         CompletableFuture<Boolean> completablefuture = this.f_210857_ != null ? this.f_210857_.f_210878_ : CompletableFuture.supplyAsync(this::m_210874_, Util.backgroundExecutor());
         this.f_210857_ = new TitleScreen.Warning32Bit(MultiLineLabel.create(this.font, new TranslatableComponent("title.32bit.deprecation"), 350, 2), this.width / 2, l - 24, completablefuture);
      }
   ...
   private boolean m_210874_() {
      try {
         return this.f_210858_.listWorlds().servers.stream().anyMatch((p_211781_) -> {
   ...
   private void createDemoMenuOptions(int p_96773_, int p_96774_) {
      ...
      this.addRenderableWidget(new Button(this.width / 2 - 100, p_96773_, 200, 20, new TranslatableComponent("menu.playdemo"), (p_211786_) -> {
         if (flag) {
            ...
            this.minecraft.m_205185_("Demo_World", MinecraftServer.DEMO_SETTINGS, registryaccess, WorldGenSettings.demoSettings(registryaccess));
         }
   ...
   public void render(PoseStack p_96739_, int p_96740_, int p_96741_, float p_96742_) {
      ...
      if ((l & -67108864) != 0) {
         ...
         if (this.f_210857_ != null) {
            this.f_210857_.f_210875_.m_207298_(p_96739_, this.f_210857_.f_210876_, this.f_210857_.f_210877_, 9, 2, 1428160512);
            this.f_210857_.f_210875_.renderCentered(p_96739_, this.f_210857_.f_210876_, this.f_210857_.f_210877_, 9, 16777215 | l);
         }
   ...
   @OnlyIn(Dist.CLIENT)
   static record Warning32Bit(MultiLineLabel f_210875_, int f_210876_, int f_210877_, CompletableFuture<Boolean> f_210878_) {
   }
}
