...
public class FogRenderer {
   ...
   public static void setupColor(Camera p_109019_, float p_109020_, ClientLevel p_109021_, int p_109022_, float p_109023_) {
      ...
      if (fogtype == FogType.WATER) {
         ...
         int j = p_109021_.m_204166_(new BlockPos(p_109019_.getPosition())).m_203334_().getWaterFogColor();
         ...
         Vec3 vec32 = CubicSampler.gaussianSampleVec3(vec31, (p_109033_, p_109034_, p_109035_) -> {
            return p_109021_.effects().getBrightnessDependentFogColor(Vec3.fromRGB24(biomemanager.m_204210_(p_109033_, p_109034_, p_109035_).m_203334_().getFogColor()), f11);
         });
      ...
      float f5 = ((float)p_109019_.getPosition().y - (float)p_109021_.getMinBuildHeight()) * p_109021_.getLevelData().m_205519_();
   ...
   public static void setupFog(Camera p_109025_, FogRenderer.FogMode p_109026_, float p_109027_, boolean p_109028_, float partialTicks) {
      ...
      if (fogtype == FogType.LAVA) {
         ...
         if (entity instanceof LocalPlayer) {
            ...
            Holder<Biome> holder = localplayer.level.m_204166_(localplayer.blockPosition());
            if (Biome.m_204183_(holder) == Biome.BiomeCategory.SWAMP) {
               f1 *= 0.85F;
            }
         }
