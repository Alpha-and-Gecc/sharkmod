...
public class LiquidBlockRenderer {
   ...
   public static boolean m_203166_(BlockAndTintGetter p_203167_, BlockPos p_203168_, FluidState p_203169_, BlockState p_203170_, Direction p_203171_, FluidState p_203172_) {
      return !isFaceOccludedBySelf(p_203167_, p_203168_, p_203170_, p_203171_) && !m_203185_(p_203169_, p_203172_);
   }
   ...
   public boolean m_203173_(BlockAndTintGetter p_203174_, BlockPos p_203175_, VertexConsumer p_203176_, BlockState p_203177_, FluidState p_203178_) {
      boolean flag = p_203178_.m_205070_(FluidTags.LAVA);
      ...
      boolean flag1 = !m_203185_(p_203178_, fluidstate1);
      boolean flag2 = m_203166_(p_203174_, p_203175_, p_203178_, p_203177_, Direction.DOWN, fluidstate) && !m_203179_(p_203174_, p_203175_, Direction.DOWN, 0.8888889F, blockstate);
      boolean flag3 = m_203166_(p_203174_, p_203175_, p_203178_, p_203177_, Direction.NORTH, fluidstate2);
      boolean flag4 = m_203166_(p_203174_, p_203175_, p_203178_, p_203177_, Direction.SOUTH, fluidstate3);
      boolean flag5 = m_203166_(p_203174_, p_203175_, p_203178_, p_203177_, Direction.WEST, fluidstate4);
      boolean flag6 = m_203166_(p_203174_, p_203175_, p_203178_, p_203177_, Direction.EAST, fluidstate5);
      if (!flag1 && !flag2 && !flag6 && !flag5 && !flag3 && !flag4) {
         ...
         float f11 = this.m_203160_(p_203174_, fluid, p_203175_, p_203177_, p_203178_);
         float f7;
         float f8;
         float f9;
         float f10;
         if (f11 >= 1.0F) {
            ...
            float f12 = this.m_203160_(p_203174_, fluid, p_203175_.north(), blockstate2, fluidstate2);
            float f13 = this.m_203160_(p_203174_, fluid, p_203175_.south(), blockstate3, fluidstate3);
            float f14 = this.m_203160_(p_203174_, fluid, p_203175_.east(), blockstate5, fluidstate5);
            float f15 = this.m_203160_(p_203174_, fluid, p_203175_.west(), blockstate4, fluidstate4);
            f7 = this.m_203149_(p_203174_, fluid, f11, f12, f14, p_203175_.relative(Direction.NORTH).relative(Direction.EAST));
            f8 = this.m_203149_(p_203174_, fluid, f11, f12, f15, p_203175_.relative(Direction.NORTH).relative(Direction.WEST));
            f9 = this.m_203149_(p_203174_, fluid, f11, f13, f14, p_203175_.relative(Direction.SOUTH).relative(Direction.EAST));
            f10 = this.m_203149_(p_203174_, fluid, f11, f13, f15, p_203175_.relative(Direction.SOUTH).relative(Direction.WEST));
         }
         ...
         if (flag1 && !m_203179_(p_203174_, p_203175_, Direction.UP, Math.min(Math.min(f8, f10), Math.min(f9, f7)), blockstate1)) {
            flag7 = true;
            f8 -= 0.001F;
            f10 -= 0.001F;
            f9 -= 0.001F;
         ...
         for(Direction direction : Direction.Plane.HORIZONTAL) {
            ...
            if (flag8 && !m_203179_(p_203174_, p_203175_, direction, Math.max(f44, f45), p_203174_.getBlockState(p_203175_.relative(direction)))) {
               flag7 = true;
   ...
   private float m_203156_(BlockAndTintGetter p_203157_, Fluid p_203158_, BlockPos p_203159_) {
      ...
      return this.m_203160_(p_203157_, p_203158_, p_203159_, blockstate, blockstate.getFluidState());
   }
