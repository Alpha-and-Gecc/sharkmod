...
public class RegistryDumpReport implements DataProvider {
   ...
   public void run(HashCache p_124061_) throws IOException {
      ...
      Registry.REGISTRY.m_203611_().forEach((p_211088_) -> {
         jsonobject.add(p_211088_.m_205785_().location().toString(), dumpRegistry(p_211088_.m_203334_()));
      });
   ...
   private static <T> JsonElement dumpRegistry(Registry<T> p_124059_) {
      ...
      p_124059_.m_203611_().forEach((p_211092_) -> {
         T t = p_211092_.m_203334_();
         int j = p_124059_.getId(t);
         JsonObject jsonobject2 = new JsonObject();
         jsonobject2.addProperty("protocol_id", j);
         jsonobject1.add(p_211092_.m_205785_().location().toString(), jsonobject2);
      });
