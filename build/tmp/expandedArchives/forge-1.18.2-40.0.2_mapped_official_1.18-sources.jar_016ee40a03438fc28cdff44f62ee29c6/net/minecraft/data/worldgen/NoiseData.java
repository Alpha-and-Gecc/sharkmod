...
public class NoiseData {
   public static Holder<NormalNoise.NoiseParameters> m_206433_() {
      ...
      return BuiltinRegistries.NOISE.m_203611_().iterator().next();
   }
   ...
   private static void register(ResourceKey<NormalNoise.NoiseParameters> p_194751_, int p_194752_, double p_194753_, double... p_194754_) {
      BuiltinRegistries.m_206384_(BuiltinRegistries.NOISE, p_194751_, new NormalNoise.NoiseParameters(p_194752_, p_194753_, p_194754_));
   }
}