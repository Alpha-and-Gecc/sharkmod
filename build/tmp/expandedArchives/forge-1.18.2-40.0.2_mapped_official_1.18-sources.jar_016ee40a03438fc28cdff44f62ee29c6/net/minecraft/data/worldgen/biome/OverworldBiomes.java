...
public class OverworldBiomes {
   ...
   public static Biome oldGrowthTaiga(boolean p_194877_) {
      ...
      biomegenerationsettings$builder.m_204201_(GenerationStep.Decoration.VEGETAL_DECORATION, p_194877_ ? VegetationPlacements.TREES_OLD_GROWTH_SPRUCE_TAIGA : VegetationPlacements.TREES_OLD_GROWTH_PINE_TAIGA);
   ...
   public static Biome plains(boolean p_194882_, boolean p_194883_, boolean p_194884_) {
      ...
      if (p_194883_) {
         ...
         if (p_194884_) {
            biomegenerationsettings$builder.m_204201_(GenerationStep.Decoration.SURFACE_STRUCTURES, MiscOverworldPlacements.ICE_SPIKE);
            biomegenerationsettings$builder.m_204201_(GenerationStep.Decoration.SURFACE_STRUCTURES, MiscOverworldPlacements.ICE_PATCH);
         }
      } else {
         ...
         if (p_194882_) {
            biomegenerationsettings$builder.m_204201_(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_SUNFLOWER);
         }
      }
      ...
      BiomeDefaultFeatures.addDefaultMushrooms(biomegenerationsettings$builder);
      if (p_194882_) {
         biomegenerationsettings$builder.m_204201_(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_SUGAR_CANE);
         biomegenerationsettings$builder.m_204201_(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_PUMPKIN);
      } else {
         BiomeDefaultFeatures.addDefaultExtraVegetation(biomegenerationsettings$builder);
      }
   ...
   public static Biome coldOcean(boolean p_194900_) {
      ...
      biomegenerationsettings$builder.m_204201_(GenerationStep.Decoration.VEGETAL_DECORATION, p_194900_ ? AquaticPlacements.SEAGRASS_DEEP_COLD : AquaticPlacements.SEAGRASS_COLD);
   ...
   public static Biome ocean(boolean p_194903_) {
      ...
      BiomeGenerationSettings.Builder biomegenerationsettings$builder = baseOceanGeneration();
      biomegenerationsettings$builder.m_204201_(GenerationStep.Decoration.VEGETAL_DECORATION, p_194903_ ? AquaticPlacements.SEAGRASS_DEEP : AquaticPlacements.SEAGRASS_NORMAL);
      BiomeDefaultFeatures.addDefaultSeagrass(biomegenerationsettings$builder);
      BiomeDefaultFeatures.addColdOceanExtraVegetation(biomegenerationsettings$builder);
   ...
   public static Biome lukeWarmOcean(boolean p_194906_) {
      ...
      BiomeGenerationSettings.Builder biomegenerationsettings$builder = baseOceanGeneration();
      biomegenerationsettings$builder.m_204201_(GenerationStep.Decoration.VEGETAL_DECORATION, p_194906_ ? AquaticPlacements.SEAGRASS_DEEP_WARM : AquaticPlacements.SEAGRASS_WARM);
      if (p_194906_) {
         BiomeDefaultFeatures.addDefaultSeagrass(biomegenerationsettings$builder);
      }
   ...
   public static Biome warmOcean() {
      ...
      BiomeGenerationSettings.Builder biomegenerationsettings$builder = baseOceanGeneration().m_204201_(GenerationStep.Decoration.VEGETAL_DECORATION, AquaticPlacements.WARM_OCEAN_VEGETATION).m_204201_(GenerationStep.Decoration.VEGETAL_DECORATION, AquaticPlacements.SEAGRASS_WARM).m_204201_(GenerationStep.Decoration.VEGETAL_DECORATION, AquaticPlacements.SEA_PICKLE);
   ...
   public static Biome forest(boolean p_194892_, boolean p_194893_, boolean p_194894_) {
      ...
      globalOverworldGeneration(biomegenerationsettings$builder);
      if (p_194894_) {
         biomegenerationsettings$builder.m_204201_(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.FLOWER_FOREST_FLOWERS);
      } else {
      ...
      BiomeDefaultFeatures.addDefaultSoftDisks(biomegenerationsettings$builder);
      if (p_194894_) {
         biomegenerationsettings$builder.m_204201_(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.TREES_FLOWER_FOREST);
         biomegenerationsettings$builder.m_204201_(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.FLOWER_FLOWER_FOREST);
         BiomeDefaultFeatures.addDefaultGrass(biomegenerationsettings$builder);
      } else {
         if (p_194892_) {
            if (p_194893_) {
   ...
   public static Biome darkForest() {
      ...
      BiomeGenerationSettings.Builder biomegenerationsettings$builder = new BiomeGenerationSettings.Builder();
      globalOverworldGeneration(biomegenerationsettings$builder);
      biomegenerationsettings$builder.m_204201_(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.DARK_FOREST_VEGETATION);
      BiomeDefaultFeatures.addForestFlowers(biomegenerationsettings$builder);
      BiomeDefaultFeatures.addDefaultOres(biomegenerationsettings$builder);
      BiomeDefaultFeatures.addDefaultSoftDisks(biomegenerationsettings$builder);
      BiomeDefaultFeatures.addDefaultFlowers(biomegenerationsettings$builder);
   ...
   public static Biome swamp() {
      ...
      biomegenerationsettings$builder.m_204201_(GenerationStep.Decoration.VEGETAL_DECORATION, AquaticPlacements.SEAGRASS_SWAMP);
   ...
   public static Biome river(boolean p_194915_) {
      ...
      BiomeDefaultFeatures.addDefaultExtraVegetation(biomegenerationsettings$builder);
      if (!p_194915_) {
         biomegenerationsettings$builder.m_204201_(GenerationStep.Decoration.VEGETAL_DECORATION, AquaticPlacements.SEAGRASS_RIVER);
      }
   ...
   public static Biome theVoid() {
      BiomeGenerationSettings.Builder biomegenerationsettings$builder = new BiomeGenerationSettings.Builder();
      biomegenerationsettings$builder.m_204201_(GenerationStep.Decoration.TOP_LAYER_MODIFICATION, MiscOverworldPlacements.VOID_START_PLATFORM);
