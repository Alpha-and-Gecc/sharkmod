...
public class DedicatedServerProperties extends Settings<DedicatedServerProperties> {
   ...
   private final DedicatedServerProperties.WorldGenProperties f_207539_ = new DedicatedServerProperties.WorldGenProperties(this.get("level-seed", ""), this.get("generator-settings", (p_211543_) -> {
   ...
   public WorldGenSettings getWorldGenSettings(RegistryAccess p_180928_) {
      if (this.worldGenSettings == null) {
         this.worldGenSettings = WorldGenSettings.m_209716_(p_180928_, this.f_207539_);
      }

      return this.worldGenSettings;
   }

   public static record WorldGenProperties(String f_207542_, JsonObject f_207543_, boolean f_207544_, String f_207545_) {
   }
}