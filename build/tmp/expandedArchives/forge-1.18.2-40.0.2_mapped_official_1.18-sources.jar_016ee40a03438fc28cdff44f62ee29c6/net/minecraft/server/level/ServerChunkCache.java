...
public class ServerChunkCache extends ChunkSource {
   ...
   private void tickChunks() {
      ...
      if (flag) {
         ...
         for(ServerChunkCache.ChunkAndHolder serverchunkcache$chunkandholder : list) {
            ...
            if ((this.level.m_201916_(chunkpos) && this.chunkMap.anyPlayerCloseEnoughForSpawning(chunkpos)) || this.distanceManager.shouldForceTicks(chunkpos.toLong())) {
   ...
   public void m_201915_() {
      this.distanceManager.m_201910_();
   }
