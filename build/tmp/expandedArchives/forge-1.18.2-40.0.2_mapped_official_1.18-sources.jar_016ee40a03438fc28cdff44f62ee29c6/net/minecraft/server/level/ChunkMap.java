...
public class ChunkMap extends ChunkStorage implements ChunkHolder.PlayerProvider {
   ...
   private static boolean isChunkOnEuclideanBorder(int p_183829_, int p_183830_, int p_183831_, int p_183832_, int p_183833_) {
   ...
   public boolean m_201907_() {
      return this.lightEngine.hasLightWork() || !this.pendingUnloads.isEmpty() || !this.updatingChunkMap.isEmpty() || this.poiManager.m_202164_() || !this.toDrop.isEmpty() || !this.unloadQueue.isEmpty() || this.queueSorter.m_201909_() || this.distanceManager.m_201911_();
   }
      ...
      completablefuture.thenAcceptAsync((p_203002_) -> {
         ...
         if (completablefuture1 != completablefuture) {
            ...
            if (this.pendingUnloads.remove(p_140182_, p_140183_) && p_203002_ != null) {
               ...
               this.f_202981_.remove(p_203002_.getPos().toLong());
            }
      ...
      if (i != this.viewDistance) {
         ...
         for(ChunkHolder chunkholder : this.updatingChunkMap.values()) {
            ...
            this.getPlayers(chunkpos, false).forEach((p_212857_) -> {
               ...
               boolean flag = m_200878_(chunkpos.x, chunkpos.z, sectionpos.x(), sectionpos.z(), j);
               boolean flag1 = m_200878_(chunkpos.x, chunkpos.z, sectionpos.x(), sectionpos.z(), this.viewDistance);
   ...
   void updatePlayerStatus(ServerPlayer p_140193_, boolean p_140194_) {
      ...
      for(int l = i - this.viewDistance - 1; l <= i + this.viewDistance + 1; ++l) {
         for(int k = j - this.viewDistance - 1; k <= j + this.viewDistance + 1; ++k) {
            if (m_200878_(l, k, i, j, this.viewDistance)) {
      ...
      if (Math.abs(k - i2) <= this.viewDistance * 2 && Math.abs(l - j2) <= this.viewDistance * 2) {
         ...
         for(int k1 = l2; k1 <= k3; ++k1) {
            for(int l1 = j3; l1 <= l3; ++l1) {
               boolean flag5 = m_200878_(k1, l1, k, l, this.viewDistance);
               boolean flag6 = m_200878_(k1, l1, i2, j2, this.viewDistance);
         ...
         for(int i1 = k - this.viewDistance - 1; i1 <= k + this.viewDistance + 1; ++i1) {
            for(int j1 = l - this.viewDistance - 1; j1 <= l + this.viewDistance + 1; ++j1) {
               if (m_200878_(i1, j1, k, l, this.viewDistance)) {
                  boolean flag3 = true;
                  boolean flag4 = false;
         ...
         for(int k2 = i2 - this.viewDistance - 1; k2 <= i2 + this.viewDistance + 1; ++k2) {
            for(int i3 = j2 - this.viewDistance - 1; i3 <= j2 + this.viewDistance + 1; ++i3) {
               if (m_200878_(k2, i3, i2, j2, this.viewDistance)) {
                  boolean flag7 = false;
                  boolean flag8 = true;
   ...
   public List<ServerPlayer> getPlayers(ChunkPos p_183801_, boolean p_183802_) {
      ...
      for(ServerPlayer serverplayer : set) {
         ...
         if (p_183802_ && isChunkOnEuclideanBorder(p_183801_.x, p_183801_.z, sectionpos.x(), sectionpos.z(), this.viewDistance) || !p_183802_ && m_200878_(p_183801_.x, p_183801_.z, sectionpos.x(), sectionpos.z(), this.viewDistance)) {
            builder.add(serverplayer);
         }
      }
