      ...
      if (Strings.isNullOrEmpty(p_143737_)) {
         ...
         try {
            ...
            if (s.isEmpty()) {
               ...
               URL url = m_212245_(uri, jsonobject1, "chat", "v1/chat");
               URL url1 = m_212245_(uri, jsonobject1, "join", "v1/join");
               URL url2 = m_212245_(uri, jsonobject1, "leave", "v1/leave");
